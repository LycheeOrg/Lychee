...
> This will help us understand the issue and prioritize it accordingly. You can use our [demo environment][4] to test your PoC.

Please do not report security vulnerabilities which are direct output of your own tools.
We are starting to see a lot of reports which are generated by automated AI scanners and contains hallucinations or do not consider parts of the codebase.

> [!CAUTION]
> For each low quality report that is closed, you gain 1 strike: :baseball:  
> 3 strikes and you will be blocked from reporting any further security vulnerabilities.
