...
import ShareAlbum from "@/v7/components/modals/ShareAlbum.vue";
import AlbumHero from "@/v7/components/gallery/albumModule/AlbumHero.vue";
import AlbumEdit from "@/v7/components/drawers/AlbumEdit.vue";
import AlbumHeader from "@/v7/components/headers/AlbumHeader.vue";
...
import AlbumStatistics from "@/v7/components/drawers/AlbumStatistics.vue";
...
import BuyMeDialog from "@/v7/components/forms/gallery-dialogs/BuyMeDialog.vue";
import ApplyRenamerDialog from "@/v7/components/forms/album/ApplyRenamerDialog.vue";
import WatermarkConfirmDialog from "@/v7/components/forms/album/WatermarkConfirmDialog.vue";
import DownloadAlbum from "@/v7/components/modals/DownloadAlbum.vue";
import { useToast } from "primevue/usetoast";
import Pagination from "@/v7/components/pagination/Pagination.vue";
