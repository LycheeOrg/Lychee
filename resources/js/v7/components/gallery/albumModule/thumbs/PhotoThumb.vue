...
import ThumbBadge from "@/v7/components/gallery/albumModule/thumbs/ThumbBadge.vue";
import ThumbRatingOverlay from "@/v7/components/gallery/albumModule/thumbs/ThumbRatingOverlay.vue";
