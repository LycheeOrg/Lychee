...
import Textarea from "@/v7/components/forms/basic/Textarea.vue";
import Button from "primevue/button";
import PricesInput from "@/v7/components/forms/shop-management/PricesInput.vue";
import PrintSizePricesInput from "@/v7/components/forms/shop-management/PrintSizePricesInput.vue";
import PixelSizePricesInput from "@/v7/components/forms/shop-management/PixelSizePricesInput.vue";
