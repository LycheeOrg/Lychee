...
import SizeVariantMeter from "@/v7/components/statistics/SizeVariantMeter.vue";
import TotalCard from "@/v7/components/statistics/TotalCard.vue";
import AlbumsTable from "@/v7/components/statistics/AlbumsTable.vue";
import OpenLeftMenu from "@/v7/components/headers/OpenLeftMenu.vue";
import Activity from "@/v7/components/statistics/Activity.vue";
