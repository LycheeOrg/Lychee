...
import ConfigGroup from "@/v7/components/settings/ConfigGroup.vue";
import ConfirmSave from "@/v7/components/settings/ConfirmSave.vue";
import General from "@/v7/components/settings/General.vue";
import AllSettings from "@/v7/components/settings/AllSettings.vue";
import { type MenuItem } from "primevue/menuitem";
import CssJs from "@/v7/components/settings/CssJs.vue";
