<template>
	...
	>
		<h2 class="font-bold text-xl">{{ $t("webshop.cancelledFailed.paymentCancelled") }}</h2>
		<div class="text-muted-color">
			<p>
				{{ $t("webshop.cancelledFailed.paymentCancelledMessage") }}
			</p>
		</div>
	</div>
	<div
	...
	>
		...
		<div class="text-muted-color">
			<p>
				{{ $t("webshop.cancelledFailed.paymentFailedMessage") }}
			</p>
		</div>
	</div>
</template>
