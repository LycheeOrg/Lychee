<template>
	<div class="w-full mb-8" v-if="options?.is_lycheeorg_disclaimer_enabled && initData?.settings.can_edit">
		...
		<p class="text-muted-color">
			...
			<span class="text-muted-color-emphasis">LycheeOrg is not responsible</span> nor liable
			<span class="text-muted-color-emphasis">for any issues or losses</span> arising from the use of the webshop module and/or the payment
			processing capabilities. It is critical that you verify and
