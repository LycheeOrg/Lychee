<template>
	<div id="image_overlay" class="absolute bottom-7 left-7 text-shadow text-white pointer-events-none" v-if="image_overlay_type !== 'none'">
		...
		></p>
		<p class="mt-1 text-base sm:text-xl text-surface-400" v-if="image_overlay_type === 'date'">
		...
		<p class="mt-1 text-base sm:text-xl text-surface-400" v-if="image_overlay_type === 'exif' && props.photo.precomputed.is_video">
