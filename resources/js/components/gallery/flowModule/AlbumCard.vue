<template>
	...
	>
		<HeaderImage v-if="header" :header="header" :image_header_cover="props.config.image_header_cover" :title="props.album.title" />
		<TopImages v-else :photos="props.album.photos" :albumId="props.album.id" />
		<CarouselImages
