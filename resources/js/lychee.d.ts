		...
		namespace Resources {
			...
			namespace Models {
				...
				export type HeadPersonAlbumResource = {
					...
					show_persons: App.Http.Resources.Models.Utils.PersonNameResource[];
					policy: App.Http.Resources.Models.Utils.AlbumProtectionPolicy;
					rights: App.Http.Resources.Rights.AlbumRightsResource;
					preFormattedData: App.Http.Resources.Models.Utils.PreFormattedAlbumData;
					editable: App.Http.Resources.Editable.EditableBaseAlbumResource | null;
				...
				export type SecurityAdvisoryResource = {
					...
					readonly cvss_vector: string | null;
				};
				...
				namespace Utils {
					...
					export type PersonNameResource = {
						id: string;
						name: string;
					};
			...
			namespace Root {
				export type AuthConfig = {
					readonly oauthProviders: App.Enum.OauthProvidersType[];
					readonly u2f_enabled: boolean;
				};
			...
			namespace Shop {
				...
				export type CheckoutResource = {
					...
					readonly order: App.Http.Resources.Shop.OrderResource | null;
				};
