<template>
	<UInputNumber
		...
		placeholder="Price"
		:step="0.01"
		:format-options="{ style: 'currency', currency: props.currency, currencyDisplay: 'symbol' }"
		class="border-0 w-full border-b hover:border-b-primary focus:border-b-primary"
