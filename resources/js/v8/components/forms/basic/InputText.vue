...
const classValue = ref((props.class ?? "") + " border-0 w-full border-b hover:border-b-primary focus:border-b-primary");
const mappedSize = computed(() => (props.size === "small" ? "sm" : props.size === "large" ? "lg" : "md"));
</script>
