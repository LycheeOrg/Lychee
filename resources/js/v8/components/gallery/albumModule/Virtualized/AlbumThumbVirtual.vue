<template>
	...
	>
		...
		<template v-else>
			<!-- No cover_id (FR-062-15's no-cover fallback): a password icon when
...
/**
 * Forked from AlbumThumb.vue (FR-062-15) — the tile component mounted per
 ...
 * analytic itemsPerRow/tileWidth computation (FR-062-14, albumTileWidth.ts)
