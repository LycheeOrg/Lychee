<template>
	<span class="badge inline-block ltr:ml-1 rtl:mr-1 px-2 pt-2 pb-1 rounded-md rounded-t-none text-white text-center" :class="spanClass">
		<UIcon v-if="props.pi" :name="`prime:${piIconName}`" :class="piExtraClasses" />
...
// `pi` historically also carried extra Tailwind classes space-separated after the icon name (e.g. "shield text-amber-500").
