<template>
	<UModal v-model:open="is_album_edit_open" fullscreen :title="$t('gallery.album.edit_title')" @update:open="onOpenChange">
		<template #body>
			<div class="w-full flex justify-center flex-wrap flex-row-reverse">
				<ul
				...
				>
					<li
						:class="{
							...
							'xl:border-l-2': isLTR(),
							'xl:border-r-2': !isLTR(),
							'max-xl:border-b-2 border-solid border-primary text-primary hover:border-primary/70 hover:text-primary/70': true,
							'bg-primary/5': activeTab === 0,
						}"
						@click="activeTab = 0"
					>
