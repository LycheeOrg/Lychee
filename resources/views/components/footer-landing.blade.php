<div id="footer" class="absolute bg-black z-10 left-0 right-0 bottom-0 text-center py-1 px-0">
	<div id="home_socials" class="animate animate-up fixed bottom-8 left-0 right-0 text-center z-10 opacity-100">
		@if($facebook !== '')
	...
	@isset($copyright)
		<p class="home_copyright uppercase text-white text-3xs font-normal">{{ $copyright }}</p>
	@endisset
	@isset($personal_text)
		<p class="personal_text text-white text-3xs font-normal">{{ $personal_text }}</p>
	@endisset
</div>
