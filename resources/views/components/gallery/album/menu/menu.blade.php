...
<div class="w-full sm:m-7 mb-4 flex justify-center flex-wrap flex-row-reverse"
    x-cloak x-show="detailsOpen" x-collapse.duration.300ms >
    <ul class="
    ...
    <div class="w-full xl:w-5/6 flex justify-center flex-wrap" x-cloak x-show="detailsActiveTab === 0">
        <livewire:forms.album.properties :album="$album" />
        <livewire:forms.album.visibility :album="$album" />
    </div>
    @if ($userCount > 1)
    <div class="w-full xl:w-5/6 flex justify-center flex-wrap" x-cloak x-show="detailsActiveTab === 1">
        <livewire:forms.album.share-with :album="$album" />
    </div>
    @endif
    <div class="w-full xl:w-5/6 flex justify-center flex-wrap" x-cloak x-show="detailsActiveTab === 2">
        <livewire:forms.album.move-panel :album="$album" />
    </div>
    <div class="w-full xl:w-5/6 flex justify-center flex-wrap" x-cloak x-show="detailsActiveTab === 3">
