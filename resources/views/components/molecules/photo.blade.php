<div wire:click="$emit('openPhoto', '{{ $photo_id }}')"
	...
	>
	@if ($show_live)
		@include('components.atoms.photo.thumb-live')
	@elseif ($show_play)
		@include('components.atoms.photo.thumb-play')
	@elseif ($show_placeholder)
		@include('components.atoms.photo.thumb-placeholder')
	@else
		@include('components.atoms.photo.thumb-photo')
