<div id="footer" class="animate animate-up hide_footer">
    ...
    @if($infos['copyright_enable'] == '1')
        <p class="home_copyright">
			{!! sprintf(__('FOOTER_COPYRIGHT'), $infos['owner'], $infos['copyright_year']) !!}</p>
    @endif
    ...
    @if($page_config['show_hosted_by'])
        <p class="hosted_by"><a rel="noopener noreferrer" target="_blank" href="https://LycheeOrg.github.io" tabindex="-1">{{ __('HOSTED_WITH_LYCHEE') }}</a></p>
    @endif
</div>
