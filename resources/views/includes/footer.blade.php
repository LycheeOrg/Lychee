<div id="footer" class="animate animate-up hide_footer">
    ...
    @if($infos['copyright_enable'] == '1')
        <p class="home_copyright">
			{!! sprintf(__('landing.copyright'), $infos['owner'], $infos['copyright_year']) !!}</p>
    @endif
    ...
    @if($page_config['show_hosted_by'] && !resolve(\App\Repositories\ConfigManager::class)->getValueAsBool('white_label_enabled'))
