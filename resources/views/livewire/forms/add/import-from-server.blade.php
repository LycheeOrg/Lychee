<div>
	<div class="p-9">
		<p class="mb-5 text-text-main-200 text-sm/4">This functionality is no longer available for the following reasons:
			<ul class="pl-5">
				...
				<li class="list-decimal list-outside">A more efficient command line alternative is available:<br>
					<pre class="inline-block font-mono text-text-main-200">php artisan lychee:sync</pre></li>
			</ul>
		</p>
	</div>
