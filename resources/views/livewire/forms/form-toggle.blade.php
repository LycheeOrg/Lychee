<div class="my-7">
	<p class="pb-2">
		...
		<label class="switch relative inline-block w-[42px] h-[22px] -bottom-0.5 leading-6">
			<input class="opacity-0 w-0 h-0" wire:model="flag" type="checkbox">
			...
			before:absolute before:content-[''] before:bg-teal-400 before:w-[14px] before:h-[14px] before:left-[3px] before:bottom-[3px] before:rounded-3xl"></span>
		</label>
	</p>
	@if($footer !== '')
	<p>
