<div class="basicModal__content">
	...
	@if($is_new_release_available)
		<span class="update-status up-to-date-release">
			– <a target="_blank" href="https://github.com/LycheeOrg/Lychee/releases" data-tabindex="-1">{{ __('lychee.UPDATE_AVAILABLE') }}</a>
		</span>
	@elseif($is_git_update_available)
		<span class="update-status up-to-date-git">
			– <a target="_blank" href="https://github.com/LycheeOrg/Lychee" data-tabindex="-1">{{ __('lychee.UPDATE_AVAILABLE') }}</a>
		</span>
	@endif
