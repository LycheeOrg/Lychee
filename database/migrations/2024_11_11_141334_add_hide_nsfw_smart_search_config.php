	...
	public function getConfigs(): array
	{
		return [
			[
				...
				'details' => 'Pictures placed in sensitive albums will not be shown in Smart Albums.',
				'is_secret' => false,
				'level' => 0,
			],
			[
				...
				'details' => 'Pictures placed in sensitive albums will not be shown on the Frame.',
				'is_secret' => false,
				'level' => 0,
			],
			[
				...
				'details' => 'Pictures placed in sensitive albums will not be shown on the Map.',
				'is_secret' => false,
				'level' => 0,
			],
			[
				...
				'details' => 'Pictures placed in sensitive albums will not be shown in Search.',
				'is_secret' => false,
				'level' => 0,
			],
			[
			...
			[
				...
				'details' => 'Pictures placed in sensitive albums will not be shown in the RSS feed.',
				'is_secret' => false,
				'level' => 0,
			],
			[
				...
				'details' => 'Pictures placed in sensitive albums will not be shown in the timeline page.',
				'is_secret' => false,
				'level' => 0,
			],
		];
