	...
	public function getConfigs(): array
	{
		return [
			...
			[
				...
				'details' => 'If you have a privacy policy URL, you can set it here. It will be displayed as a link alongside the consent text.',
				'is_secret' => false,
				'is_expert' => false,
				'level' => 2,
				'order' => 5,
			...
			[
				...
				'details' => 'Leave empty for default. This allows you to specify how users should expect to be contacted back (e.g. email, phone, etc.). It is just a label shown on the form, it does not have any functional effect.',
				'is_secret' => false,
				'is_expert' => true,
				'level' => 2,
				'order' => 8,
