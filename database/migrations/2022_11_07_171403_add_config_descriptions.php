...
return new class() extends Migration {
	...
	public function up()
	{
		...
		DB::table('configs')->where('key', 'imagick')->update(['description' => 'Enable/Disable imagick processing']);
		...
		DB::table('configs')->where('key', 'small_max_width')->update(['description' => 'Maximum width for small thumbs (justified album view)']);
		DB::table('configs')->where('key', 'small_max_height')->update(['description' => 'Maximum height for small thumbs (justified album view)']);
		...
		DB::table('configs')->where('key', 'delete_imported')->update(['description' => 'When uploading from server, delete originals']);
		...
		DB::table('configs')->where('key', 'force_migration_in_production')->update(['description' => 'Force migration even if app is production mode']);
		...
		DB::table('configs')->where('key', 'SL_enable')->update(['description' => 'Symbolic Link protection enabled']);
		...
		DB::table('configs')->where('key', 'raw_formats')->update(['description' => 'Allowed extra format, will not be processed']);
		...
		DB::table('configs')->where('key', 'force_32bit_ids')->update(['description' => 'Force 32 bits id in the database']);
		...
		DB::table('configs')->where('key', 'update_check_every_days')->update(['description' => 'Recurency of Lychee update checks']);
		...
		DB::table('configs')->where('key', 'rss_max_items')->update(['description' => 'Max number of itmes in the RSS feed']);
		DB::table('configs')->where('key', 'prefer_available_xmp_metadata')->update(['description' => 'Use sidecard if provided instead of exif metadata']);
		...
		DB::table('configs')->where('key', 'log_max_num_line')->update(['description' => 'Display the last X more recent lines in Logs']);
		DB::table('configs')->where('key', 'unlock_password_photos_with_url_param')->update(['description' => 'Allow password to be passed as Url param to unlock albums']);
		...
		DB::table('configs')->where('key', 'map_display_direction')->update(['description' => 'Display the direction of he picture on the map if available']);
		DB::table('configs')->where('key', 'album_subtitle_type')->update(['description' => 'Defines the subtitle of album in albums view']);
		DB::table('configs')->where('key', 'upload_processing_limit')->update(['description' => 'Maximum number of image processed in parallel']);
		DB::table('configs')->where('key', 'public_photos_hidden')->update(['description' => 'Includes singular public pictures in Search results']);
		DB::table('configs')->where('key', 'new_photos_notification')->update(['description' => 'Enable notificates when new photos are enabled']);
	}
