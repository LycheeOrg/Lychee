	...
	public function getConfigs(): array
	{
		return [
			...
			[
				...
				'details' => 'Temporarily hide Monitor-tier photos while the NSFW scan is in progress.<br> If the classifier is unavailable, the photo remains hidden until manually approved.',
				'is_expert' => true,
				'is_secret' => false,
				'level' => 1,
				'order' => 29,
			...
			[
				...
				'details' => 'Temporarily hide Trust-but-verify photos while the NSFW scan is in progress.<br> If the classifier is unavailable, the photo remains hidden until manually approved.',
				'is_expert' => true,
				'is_secret' => false,
				'level' => 1,
				'order' => 30,
			...
			[
				...
				'details' => 'Temporarily hide Trusted photos while the NSFW scan is in progress.<br> If the classifier is unavailable, the photo remains hidden until manually approved.',
				'is_expert' => true,
				'is_secret' => false,
				'level' => 1,
				'order' => 31,
