...
return new class() extends Migration {
	...
	public function up(): void
	{
		...
		try {
			...
			$this->msg_section->writeln('<error>Warning:</error> Failed to clear cache for version 7.7.2');

			return;
		}
		$this->msg_section->writeln('<info>Info:</info> Cleared cache for version 7.7.2');
	}
