...
return [
    ...
    */
        ...
        'sm_pinterest_url' => 'URL на Pinterest профил',
        'sm_deviantart_url' => 'URL на DeviantArt профил',
        'sm_tumblr_url' => 'URL на Tumblr профил',
        'sm_500px_url' => 'URL на 500px профил',
        'sm_pixelfeed_url' => 'URL на Pixelfeed профил',
        'sm_discord_url' => 'URL на Discord сървър',
        'sm_reddit_url' => 'URL на Reddit профил',
        ...
        'upload_chunk_size' => 'Размер на частите при качване.',
        ...
        'zip_bomb_max_total_size' => 'Максимален общ некомпресиран размер на качен zip архив.',
        'zip_bomb_max_file_size' => 'Максимален некомпресиран размер на един файл в качен zip архив.',
        'zip_bomb_max_entries' => 'Максимален брой записи, разрешени в качен zip архив.',
        'zip_bomb_max_ratio' => 'Максимално допустимо съотношение на компресия (некомпресирано / компресирано) на качен zip архив.',
        'zip_bomb_delete_rejected_file' => 'Изтриване на качения zip файл, когато бъде отхвърлен като zip бомба.',
    ...
    'details' => [
        ...
        'upload_chunk_size' => 'Формат: число, последвано от B, KB, MB, GB или TB (напр. „10MB“). Използвайте „0 B“ за автоматично.',
        ...
        'default_user_quota' => 'Формат: число, последвано от B, KB, MB, GB или TB (напр. „10GB“). Използвайте „0 B“, за да деактивирате квотата.',
        ...
        'zip_bomb_max_total_size' => 'Формат: число, последвано от B, KB, MB, GB или TB (напр. „10GB“). Защитава срещу атаки от тип zip бомба. Архивът се отхвърля, ако декларираният или действителният му некомпресиран размер надвиши тази граница.',
        'zip_bomb_max_file_size' => 'Формат: число, последвано от B, KB, MB, GB или TB (напр. „5GB“). Защитава срещу атаки от тип zip бомба. Архивът се отхвърля, ако някой запис надвиши тази граница в некомпресиран вид.',
        'zip_bomb_max_entries' => 'Защитава срещу атаки от типа „много малки файлове“ (отказ на услуга). Архивът се отхвърля, ако съдържа повече записи от тази стойност.',
        'zip_bomb_max_ratio' => 'Защитава срещу атаки от тип zip бомба, разчитащи на екстремни съотношения на компресия. Архивът се отхвърля, ако общото му съотношение надвиши тази стойност.',
        'zip_bomb_delete_rejected_file' => 'Когато е активирано, оригиналният zip файл се изтрива веднага щом бъде установено, че надвишава конфигурираните граници за защита срещу zip бомби. Деактивирайте, за да запазите файла на диска за ръчна проверка.',
    ...
    'category_description' => [
        ...
        'Gallery' => '',
        'Mod Welcome' => 'Този модул активира начална страница. Вместо да попадате директно в изгледа на галерията, той добавя малко тържественост при влизането в уебсайта. Предоставете URL адреса на изображението, което да се показва, и задайте заглавие. Препоръчваме да използвате разширението Landing Page, достъпно в администраторския панел, вместо тези отделни настройки, тъй като то предоставя преглед на промените ви в реално време.',
        'Footer' => '',
        'Smart Albums' => '',
        'Image Processing' => '',
        'Mod Search' => '',
