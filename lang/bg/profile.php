...
return [
    ...
    */
    ...
    'admin_setup' => [
        'header' => 'Настройте своя администраторски акаунт',
        'welcome' => 'Добре дошли в Lychee,<br>нека започнем със създаването на администраторски акаунт.',
        'submit' => 'Създаване на администраторски акаунт',
        'success' => 'Администраторският акаунт беше създаден успешно.',
        'error' => 'Възникна грешка при създаването на администраторския акаунт.',
        'already_exists' => 'Администраторски акаунт вече е настроен.',
    ],
    'token' => [
