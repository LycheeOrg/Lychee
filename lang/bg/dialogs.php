...
return [
    ...
    */
    ...
    'share_nfc' => [
        'prompt' => 'Доближете устройството си до NFC таг, за да споделите връзката…',
        'success' => 'Връзката е споделена чрез NFC!',
        'error' => 'Споделянето чрез NFC не бе успешно.',
        'not_supported' => 'Споделянето чрез NFC не се поддържа на това устройство.',
    ],
    'photo_share_card' => [
        'by' => 'от :name',
    ],
