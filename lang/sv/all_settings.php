...
return [
    ...
    */
    ...
    'documentation' => [
        ...
        'upload_chunk_size' => 'Storlek på delarna vid uppladdning.',
        ...
        'zip_bomb_max_total_size' => 'Maximal sammanlagd okomprimerad storlek för ett uppladdat zip-arkiv.',
        'zip_bomb_max_file_size' => 'Maximal okomprimerad storlek för en enskild fil i ett uppladdat zip-arkiv.',
        'zip_bomb_max_entries' => 'Maximalt antal poster som tillåts i ett uppladdat zip-arkiv.',
        'zip_bomb_max_ratio' => 'Maximalt tillåtet komprimeringsförhållande (okomprimerad / komprimerad) för ett uppladdat zip-arkiv.',
        'zip_bomb_delete_rejected_file' => 'Ta bort den uppladdade zip-filen när den avvisas som en zip-bomb.',
    ...
    'details' => [
        ...
        'upload_chunk_size' => 'Format: ett tal följt av B, KB, MB, GB eller TB (t.ex. "10MB"). Använd "0 B" för automatiskt.',
        ...
        'default_user_quota' => 'Format: ett tal följt av B, KB, MB, GB eller TB (t.ex. "10GB"). Använd "0 B" för att inaktivera kvoten.',
        ...
        'zip_bomb_max_total_size' => 'Format: ett tal följt av B, KB, MB, GB eller TB (t.ex. "10GB"). Skyddar mot zip-bomb-attacker. Arkivet avvisas om dess angivna eller faktiska okomprimerade storlek överskrider denna gräns.',
        'zip_bomb_max_file_size' => 'Format: ett tal följt av B, KB, MB, GB eller TB (t.ex. "5GB"). Skyddar mot zip-bomb-attacker. Arkivet avvisas om någon post överskrider denna gräns okomprimerad.',
        'zip_bomb_max_entries' => 'Skyddar mot överbelastningsattacker med "många små filer". Arkivet avvisas om det innehåller fler poster än detta värde.',
        'zip_bomb_max_ratio' => 'Skyddar mot zip-bomb-attacker som bygger på extrema komprimeringsförhållanden. Arkivet avvisas om dess totala förhållande överskrider detta värde.',
        'zip_bomb_delete_rejected_file' => 'Om aktiverat tas den ursprungliga zip-filen bort så snart den upptäcks överskrida de konfigurerade skyddsgränserna mot zip-bomber. Inaktivera för att behålla filen på disken för manuell granskning.',
