...
return [
    ...
    */
    ...
    'documentation' => [
        ...
        'upload_chunk_size' => 'Veľkosť častí pri nahrávaní.',
        ...
        'zip_bomb_max_total_size' => 'Maximálna celková nekomprimovaná veľkosť nahraného zip archívu.',
        'zip_bomb_max_file_size' => 'Maximálna nekomprimovaná veľkosť jedného súboru v nahranom zip archíve.',
        'zip_bomb_max_entries' => 'Maximálny počet položiek povolených v nahranom zip archíve.',
        'zip_bomb_max_ratio' => 'Maximálny povolený kompresný pomer (nekomprimované / komprimované) nahraného zip archívu.',
        'zip_bomb_delete_rejected_file' => 'Odstrániť nahraný zip súbor, ak je odmietnutý ako zip bomba.',
        ...
        'selection_border_enabled' => 'Zobraziť okraj okolo vybraných miniatúr fotografií',
        'selection_overlay_enabled' => 'Zobraziť svetlomodrý prekryv na vybraných miniatúrach fotografií',
        'photo_share_card_enabled' => 'Povoliť zdieľaciu kartu fotografie v hlavičke fotografie.',
    ...
    'details' => [
        ...
        'upload_chunk_size' => 'Formát: číslo nasledované B, KB, MB, GB alebo TB (napr. „10MB“). Pre automatický režim použite „0 B“.',
        ...
        'default_user_quota' => 'Formát: číslo nasledované B, KB, MB, GB alebo TB (napr. „10GB“). Na vypnutie kvóty použite „0 B“.',
        ...
        'zip_bomb_max_total_size' => 'Formát: číslo nasledované B, KB, MB, GB alebo TB (napr. „10GB“). Chráni pred útokmi typu zip bomba. Archív je odmietnutý, ak jeho deklarovaná alebo skutočná nekomprimovaná veľkosť prekročí tento limit.',
        'zip_bomb_max_file_size' => 'Formát: číslo nasledované B, KB, MB, GB alebo TB (napr. „5GB“). Chráni pred útokmi typu zip bomba. Archív je odmietnutý, ak ktorákoľvek položka po rozbalení prekročí tento limit.',
        'zip_bomb_max_entries' => 'Chráni pred útokmi typu odmietnutie služby pomocou „mnohých malých súborov“. Archív je odmietnutý, ak obsahuje viac položiek, než je tento limit.',
        'zip_bomb_max_ratio' => 'Chráni pred útokmi typu zip bomba založenými na extrémnych kompresných pomeroch. Archív je odmietnutý, ak jeho celkový pomer prekročí túto hodnotu.',
        'zip_bomb_delete_rejected_file' => 'Ak je povolené, pôvodný zip súbor sa odstráni hneď po zistení, že prekračuje nakonfigurované limity ochrany proti zip bombám. Vypnite, ak chcete súbor ponechať na disku na manuálnu kontrolu.',
        ...
        'selection_border_enabled' => 'Ak je povolené, vybrané miniatúry fotografií sú orámované okrajom.',
        'selection_overlay_enabled' => 'Ak je povolené, vybrané miniatúry fotografií sú zafarbené svetlomodrým prekryvom.',
        'photo_share_card_enabled' => 'Ak je povolené, v hlavičke fotografie sa zobrazí tlačidlo, ktoré otvorí kartu so zobrazením názvu fotografie, QR kódom s priamym odkazom na fotografiu, vlastníkom webu a licenciou fotografie.',
