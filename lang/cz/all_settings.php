...
return [
    ...
    */
    ...
    'documentation' => [
        ...
        'upload_chunk_size' => 'Velikost částí při nahrávání.',
        ...
        'zip_bomb_max_total_size' => 'Maximální celková nekomprimovaná velikost nahraného zip archivu.',
        'zip_bomb_max_file_size' => 'Maximální nekomprimovaná velikost jednoho souboru uvnitř nahraného zip archivu.',
        'zip_bomb_max_entries' => 'Maximální počet položek povolených v nahraném zip archivu.',
        'zip_bomb_max_ratio' => 'Maximální povolený kompresní poměr (nekomprimováno / komprimováno) nahraného zip archivu.',
        'zip_bomb_delete_rejected_file' => 'Smazat nahraný zip soubor, pokud je odmítnut jako zip bomba.',
    ...
    'details' => [
        ...
        'upload_chunk_size' => 'Formát: číslo následované B, KB, MB, GB nebo TB (např. „10MB“). Pro automatický režim použijte „0 B“.',
        ...
        'default_user_quota' => 'Formát: číslo následované B, KB, MB, GB nebo TB (např. „10GB“). Pro vypnutí kvóty použijte „0 B“.',
        ...
        'zip_bomb_max_total_size' => 'Formát: číslo následované B, KB, MB, GB nebo TB (např. „10GB“). Chrání proti útokům typu zip bomba. Archiv je odmítnut, pokud jeho deklarovaná nebo skutečná nekomprimovaná velikost překročí tento limit.',
        'zip_bomb_max_file_size' => 'Formát: číslo následované B, KB, MB, GB nebo TB (např. „5GB“). Chrání proti útokům typu zip bomba. Archiv je odmítnut, pokud kterákoli položka po rozbalení překročí tento limit.',
        'zip_bomb_max_entries' => 'Chrání proti útokům typu odepření služby pomocí „mnoha malých souborů“. Archiv je odmítnut, pokud obsahuje více položek, než je tento limit.',
        'zip_bomb_max_ratio' => 'Chrání proti útokům typu zip bomba, které využívají extrémní kompresní poměry. Archiv je odmítnut, pokud jeho celkový poměr překročí tuto hodnotu.',
        'zip_bomb_delete_rejected_file' => 'Je-li povoleno, původní zip soubor se smaže, jakmile je zjištěno, že překračuje nakonfigurované limity ochrany proti zip bombám. Vypněte, chcete-li soubor ponechat na disku pro ruční kontrolu.',
