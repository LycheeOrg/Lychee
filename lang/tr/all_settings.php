...
return [
    ...
    */
        ...
        'sm_pinterest_url' => 'Pinterest profil bağlantısı',
        'sm_deviantart_url' => 'DeviantArt profil bağlantısı',
        'sm_tumblr_url' => 'Tumblr profil bağlantısı',
        'sm_500px_url' => '500px profil bağlantısı',
        'sm_pixelfeed_url' => 'Pixelfeed profil bağlantısı',
        'sm_discord_url' => 'Discord sunucu bağlantısı',
        'sm_reddit_url' => 'Reddit profil bağlantısı',
        ...
        'upload_chunk_size' => 'Yükleme sırasında parça boyutu.',
        ...
        'zip_bomb_max_total_size' => 'Yüklenen bir zip arşivinin izin verilen en yüksek toplam sıkıştırılmamış boyutu.',
        'zip_bomb_max_file_size' => 'Yüklenen bir zip arşivi içindeki tek bir dosyanın en yüksek sıkıştırılmamış boyutu.',
        'zip_bomb_max_entries' => 'Yüklenen bir zip arşivinde izin verilen en fazla giriş sayısı.',
        'zip_bomb_max_ratio' => 'Yüklenen bir zip arşivi için izin verilen en yüksek sıkıştırma oranı (sıkıştırılmamış / sıkıştırılmış).',
        'zip_bomb_delete_rejected_file' => 'Zip bombası olarak reddedildiğinde yüklenen zip dosyasını sil.',
    ...
    'details' => [
        ...
        'upload_chunk_size' => 'Biçim: B, KB, MB, GB veya TB ile biten bir sayı (ör. "10MB"). Otomatik için "0 B" kullanın.',
        ...
        'default_user_quota' => 'Biçim: B, KB, MB, GB veya TB ile biten bir sayı (ör. "10GB"). Kotayı devre dışı bırakmak için "0 B" kullanın.',
        ...
        'zip_bomb_max_total_size' => 'Biçim: B, KB, MB, GB veya TB ile biten bir sayı (ör. "10GB"). Zip bombası saldırılarına karşı koruma sağlar. Beyan edilen veya gerçek sıkıştırılmamış boyutu bu sınırı aşarsa arşiv reddedilir.',
        'zip_bomb_max_file_size' => 'Biçim: B, KB, MB, GB veya TB ile biten bir sayı (ör. "5GB"). Zip bombası saldırılarına karşı koruma sağlar. Herhangi bir giriş sıkıştırılmamış haliyle bu sınırı aşarsa arşiv reddedilir.',
        'zip_bomb_max_entries' => '"Çok sayıda küçük dosya" tabanlı hizmet reddi saldırılarına karşı koruma sağlar. Arşiv bu değerden fazla giriş içeriyorsa reddedilir.',
        'zip_bomb_max_ratio' => 'Aşırı sıkıştırma oranlarına dayanan zip bombası saldırılarına karşı koruma sağlar. Arşivin genel oranı bu değeri aşarsa reddedilir.',
        'zip_bomb_delete_rejected_file' => 'Etkinleştirildiğinde, yapılandırılmış zip bombası koruma sınırlarını aştığı tespit edilir edilmez orijinal zip dosyası silinir. Dosyayı manuel inceleme için diskte tutmak için devre dışı bırakın.',
