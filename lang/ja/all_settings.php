...
return [
    ...
    */
    ...
    'documentation' => [
        ...
        'upload_chunk_size' => 'アップロード時のチャンクサイズ。',
        ...
        'zip_bomb_max_total_size' => 'アップロードされたzipアーカイブの解凍後の合計サイズの上限。',
        'zip_bomb_max_file_size' => 'アップロードされたzipアーカイブ内の単一ファイルの解凍後サイズの上限。',
        'zip_bomb_max_entries' => 'アップロードされたzipアーカイブで許可されるエントリ数の上限。',
        'zip_bomb_max_ratio' => 'アップロードされたzipアーカイブで許容される圧縮率(解凍後/圧縮後)の上限。',
        'zip_bomb_delete_rejected_file' => 'zip爆弾として拒否された場合、アップロードされたzipファイルを削除します。',
    ...
    'details' => [
        ...
        'upload_chunk_size' => '形式: 数値の後にB、KB、MB、GBまたはTBを付けます(例:「10MB」)。自動設定にするには「0 B」を使用します。',
        ...
        'default_user_quota' => '形式: 数値の後にB、KB、MB、GBまたはTBを付けます(例:「10GB」)。クォータを無効にするには「0 B」を使用します。',
        ...
        'zip_bomb_max_total_size' => '形式: 数値の後にB、KB、MB、GBまたはTBを付けます(例:「10GB」)。zip爆弾攻撃を防ぎます。申告された、または実際の解凍後サイズがこの上限を超える場合、アーカイブは拒否されます。',
        'zip_bomb_max_file_size' => '形式: 数値の後にB、KB、MB、GBまたはTBを付けます(例:「5GB」)。zip爆弾攻撃を防ぎます。いずれかのエントリが解凍後にこの上限を超える場合、アーカイブは拒否されます。',
        'zip_bomb_max_entries' => '「大量の小さなファイル」によるサービス拒否攻撃を防ぎます。エントリ数がこの値を超える場合、アーカイブは拒否されます。',
        'zip_bomb_max_ratio' => '極端な圧縮率に依存するzip爆弾攻撃を防ぎます。全体の圧縮率がこの値を超える場合、アーカイブは拒否されます。',
        'zip_bomb_delete_rejected_file' => '有効にすると、設定されたzip爆弾防止の上限を超えていると判定された時点で、元のzipファイルが直ちに削除されます。手動で確認するためにファイルをディスクに残す場合は無効にしてください。',
