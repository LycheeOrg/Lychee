...
return [
    ...
    */
    ...
    'documentation' => [
        ...
        'upload_chunk_size' => 'Kích thước của các phần khi tải lên.',
        ...
        'zip_bomb_max_total_size' => 'Kích thước tổng hợp tối đa chưa nén của một kho lưu trữ zip được tải lên.',
        'zip_bomb_max_file_size' => 'Kích thước tối đa chưa nén của một tệp đơn lẻ trong kho lưu trữ zip được tải lên.',
        'zip_bomb_max_entries' => 'Số mục tối đa được phép trong một kho lưu trữ zip được tải lên.',
        'zip_bomb_max_ratio' => 'Tỷ lệ nén tối đa cho phép (chưa nén / đã nén) của một kho lưu trữ zip được tải lên.',
        'zip_bomb_delete_rejected_file' => 'Xóa tệp zip đã tải lên khi nó bị từ chối vì là bom zip.',
    ...
    'details' => [
        ...
        'upload_chunk_size' => 'Định dạng: một số theo sau là B, KB, MB, GB hoặc TB (ví dụ: "10MB"). Sử dụng "0 B" cho chế độ tự động.',
        ...
        'default_user_quota' => 'Định dạng: một số theo sau là B, KB, MB, GB hoặc TB (ví dụ: "10GB"). Sử dụng "0 B" để tắt hạn ngạch.',
        ...
        'zip_bomb_max_total_size' => 'Định dạng: một số theo sau là B, KB, MB, GB hoặc TB (ví dụ: "10GB"). Bảo vệ chống lại các cuộc tấn công bom zip. Kho lưu trữ bị từ chối nếu kích thước chưa nén được khai báo hoặc thực tế vượt quá giới hạn này.',
        'zip_bomb_max_file_size' => 'Định dạng: một số theo sau là B, KB, MB, GB hoặc TB (ví dụ: "5GB"). Bảo vệ chống lại các cuộc tấn công bom zip. Kho lưu trữ bị từ chối nếu bất kỳ mục nào vượt quá giới hạn này khi chưa nén.',
        'zip_bomb_max_entries' => 'Bảo vệ chống lại các cuộc tấn công từ chối dịch vụ kiểu "nhiều tệp nhỏ". Kho lưu trữ bị từ chối nếu chứa nhiều mục hơn giá trị này.',
        'zip_bomb_max_ratio' => 'Bảo vệ chống lại các cuộc tấn công bom zip dựa vào tỷ lệ nén cực cao. Kho lưu trữ bị từ chối nếu tỷ lệ tổng thể vượt quá giá trị này.',
        'zip_bomb_delete_rejected_file' => 'Khi được bật, tệp zip gốc sẽ bị xóa ngay khi phát hiện vượt quá giới hạn bảo vệ bom zip đã cấu hình. Tắt để giữ tệp trên đĩa nhằm kiểm tra thủ công.',
