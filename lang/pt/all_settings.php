...
return [
    ...
    */
    ...
    'documentation' => [
        ...
        'upload_chunk_size' => 'Tamanho dos fragmentos durante o envio.',
        ...
        'zip_bomb_max_total_size' => 'Tamanho total máximo descomprimido de um arquivo zip enviado.',
        'zip_bomb_max_file_size' => 'Tamanho máximo descomprimido de um único ficheiro dentro de um arquivo zip enviado.',
        'zip_bomb_max_entries' => 'Número máximo de entradas permitidas num arquivo zip enviado.',
        'zip_bomb_max_ratio' => 'Taxa de compressão máxima permitida (descomprimido / comprimido) de um arquivo zip enviado.',
        'zip_bomb_delete_rejected_file' => 'Eliminar o ficheiro zip enviado quando for rejeitado como uma zip bomb.',
    ...
    'details' => [
        ...
        'upload_chunk_size' => 'Formato: um número seguido de B, KB, MB, GB ou TB (ex.: "10MB"). Use "0 B" para automático.',
        ...
        'default_user_quota' => 'Formato: um número seguido de B, KB, MB, GB ou TB (ex.: "10GB"). Use "0 B" para desativar a quota.',
        ...
        'zip_bomb_max_total_size' => 'Formato: um número seguido de B, KB, MB, GB ou TB (ex.: "10GB"). Protege contra ataques de zip bomb. O arquivo é rejeitado se o seu tamanho descomprimido declarado ou real exceder este limite.',
        'zip_bomb_max_file_size' => 'Formato: um número seguido de B, KB, MB, GB ou TB (ex.: "5GB"). Protege contra ataques de zip bomb. O arquivo é rejeitado se alguma entrada exceder este limite depois de descomprimida.',
        'zip_bomb_max_entries' => 'Protege contra ataques de negação de serviço do tipo "muitos ficheiros pequenos". O arquivo é rejeitado se contiver mais entradas do que este valor.',
        'zip_bomb_max_ratio' => 'Protege contra ataques de zip bomb que dependem de taxas de compressão extremas. O arquivo é rejeitado se a sua taxa global exceder este valor.',
        'zip_bomb_delete_rejected_file' => 'Quando ativado, o ficheiro zip original é eliminado assim que for detetado que excede os limites de proteção contra zip bomb configurados. Desative para manter o ficheiro no disco para inspeção manual.',
