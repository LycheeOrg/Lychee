...
return [
    ...
    */
    ...
    'documentation' => [
        ...
        'sm_pinterest_url' => 'Url of pinterest profile',
        'sm_deviantart_url' => 'Url of deviantart profile',
        'sm_tumblr_url' => 'Url of tumblr profile',
        'sm_500px_url' => 'Url of 500px profile',
        'sm_pixelfeed_url' => 'Url of pixelfeed profile',
        'sm_discord_url' => 'Url of discord server',
        'sm_reddit_url' => 'Url of reddit profile',
        ...
        'upload_chunk_size' => 'Dimensione dei blocchi durante il caricamento.',
        ...
        'zip_bomb_max_total_size' => 'Dimensione totale massima non compressa di un archivio zip caricato.',
        'zip_bomb_max_file_size' => 'Dimensione massima non compressa di un singolo file all\'interno di un archivio zip caricato.',
        'zip_bomb_max_entries' => 'Numero massimo di voci consentite in un archivio zip caricato.',
        'zip_bomb_max_ratio' => 'Rapporto di compressione massimo consentito (non compresso / compresso) di un archivio zip caricato.',
        'zip_bomb_delete_rejected_file' => 'Elimina il file zip caricato quando viene rifiutato come zip bomb.',
        ...
        'selection_border_enabled' => 'Mostra un bordo intorno alle miniature delle foto selezionate',
        'selection_overlay_enabled' => 'Mostra una sovrapposizione blu chiaro sulle miniature delle foto selezionate',
        'photo_share_card_enabled' => 'Abilita la scheda di condivisione della foto nella barra di intestazione della foto.',
    ...
    'details' => [
        ...
        'upload_chunk_size' => 'Formato: un numero seguito da B, KB, MB, GB o TB (es. "10MB"). Usa "0 B" per l\'automatico.',
        ...
        'default_user_quota' => 'Formato: un numero seguito da B, KB, MB, GB o TB (es. "10GB"). Usa "0 B" per disabilitare la quota.',
        ...
        'zip_bomb_max_total_size' => 'Formato: un numero seguito da B, KB, MB, GB o TB (es. "10GB"). Protegge dagli attacchi zip bomb. L\'archivio viene rifiutato se la sua dimensione non compressa dichiarata o reale supera questo limite.',
        'zip_bomb_max_file_size' => 'Formato: un numero seguito da B, KB, MB, GB o TB (es. "5GB"). Protegge dagli attacchi zip bomb. L\'archivio viene rifiutato se una singola voce supera questo limite una volta decompressa.',
        'zip_bomb_max_entries' => 'Protegge dagli attacchi di tipo denial-of-service basati su "molti piccoli file". L\'archivio viene rifiutato se contiene più voci di questo valore.',
        'zip_bomb_max_ratio' => 'Protegge dagli attacchi zip bomb basati su rapporti di compressione estremi. L\'archivio viene rifiutato se il suo rapporto complessivo supera questo valore.',
        'zip_bomb_delete_rejected_file' => 'Se abilitato, il file zip originale viene eliminato non appena viene rilevato che supera i limiti di protezione zip bomb configurati. Disattiva per conservare il file su disco per un\'ispezione manuale.',
        ...
        'selection_border_enabled' => 'Se abilitato, le miniature delle foto selezionate vengono delineate con un bordo.',
        'selection_overlay_enabled' => 'Se abilitato, le miniature delle foto selezionate vengono colorate con una sovrapposizione blu chiaro.',
        'photo_share_card_enabled' => 'Se abilitato, viene mostrato un pulsante nella barra di intestazione della foto che apre una scheda con il titolo della foto, un codice QR con link diretto alla foto, il proprietario del sito e la licenza della foto.',
    ...
    'category_description' => [
        ...
        'Gallery' => '',
        'Mod Welcome' => 'This module enables a landing page. Instead of arriving directly to the gallery view, it adds a bit of grandiose to the website entrance. Provide the url of the picture to be displayed and set the title. We recommend using the Landing Page extension, accessible in the admin dashboard, instead of these individual options, as it provides a live preview of your changes.',
        'Footer' => '',
        'Smart Albums' => '',
        'Image Processing' => '',
        'Mod Search' => '',
