...
return [
    ...
    */
    ...
    'documentation' => [
        ...
        'upload_chunk_size' => 'A feltöltéskor használt darabok mérete.',
        ...
        'zip_bomb_max_total_size' => 'A feltöltött zip archívum maximális összesített, tömörítetlen mérete.',
        'zip_bomb_max_file_size' => 'Egyetlen fájl maximális tömörítetlen mérete a feltöltött zip archívumon belül.',
        'zip_bomb_max_entries' => 'A feltöltött zip archívumban megengedett bejegyzések maximális száma.',
        'zip_bomb_max_ratio' => 'A feltöltött zip archívum maximálisan megengedett tömörítési aránya (tömörítetlen / tömörített).',
        'zip_bomb_delete_rejected_file' => 'A feltöltött zip fájl törlése, ha azt zip bombaként utasítják el.',
    ...
    'details' => [
        ...
        'upload_chunk_size' => 'Formátum: egy szám, amelyet B, KB, MB, GB vagy TB követ (pl. „10MB”). Az automatikus módhoz használja a „0 B” értéket.',
        ...
        'default_user_quota' => 'Formátum: egy szám, amelyet B, KB, MB, GB vagy TB követ (pl. „10GB”). A kvóta letiltásához használja a „0 B” értéket.',
        ...
        'zip_bomb_max_total_size' => 'Formátum: egy szám, amelyet B, KB, MB, GB vagy TB követ (pl. „10GB”). Védelmet nyújt a zip bomba támadások ellen. Az archívum elutasításra kerül, ha a megadott vagy a tényleges tömörítetlen mérete meghaladja ezt a korlátot.',
        'zip_bomb_max_file_size' => 'Formátum: egy szám, amelyet B, KB, MB, GB vagy TB követ (pl. „5GB”). Védelmet nyújt a zip bomba támadások ellen. Az archívum elutasításra kerül, ha bármelyik bejegyzés tömörítetlenül meghaladja ezt a korlátot.',
        'zip_bomb_max_entries' => 'Védelmet nyújt a „sok apró fájl” típusú szolgáltatásmegtagadási támadások ellen. Az archívum elutasításra kerül, ha ennél több bejegyzést tartalmaz.',
        'zip_bomb_max_ratio' => 'Védelmet nyújt a szélsőséges tömörítési arányra épülő zip bomba támadások ellen. Az archívum elutasításra kerül, ha teljes aránya meghaladja ezt az értéket.',
        'zip_bomb_delete_rejected_file' => 'Ha engedélyezve van, az eredeti zip fájl azonnal törlődik, amint kiderül, hogy túllépi a beállított zip bomba elleni védelem korlátait. Kapcsolja ki, ha meg szeretné tartani a fájlt a lemezen kézi ellenőrzéshez.',
