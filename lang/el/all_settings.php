...
return [
    ...
    */
    ...
    'documentation' => [
        ...
        'upload_chunk_size' => 'Μέγεθος τμημάτων κατά το ανέβασμα.',
        ...
        'zip_bomb_max_total_size' => 'Μέγιστο συνολικό μη συμπιεσμένο μέγεθος ενός ανεβασμένου αρχείου zip.',
        'zip_bomb_max_file_size' => 'Μέγιστο μη συμπιεσμένο μέγεθος ενός μεμονωμένου αρχείου μέσα σε ένα ανεβασμένο zip.',
        'zip_bomb_max_entries' => 'Μέγιστος αριθμός καταχωρήσεων που επιτρέπονται σε ένα ανεβασμένο αρχείο zip.',
        'zip_bomb_max_ratio' => 'Μέγιστη επιτρεπόμενη αναλογία συμπίεσης (μη συμπιεσμένο / συμπιεσμένο) ενός ανεβασμένου αρχείου zip.',
        'zip_bomb_delete_rejected_file' => 'Διαγραφή του ανεβασμένου αρχείου zip όταν απορρίπτεται ως βόμβα zip.',
    ...
    'details' => [
        ...
        'upload_chunk_size' => 'Μορφή: ένας αριθμός ακολουθούμενος από B, KB, MB, GB ή TB (π.χ. «10MB»). Χρησιμοποιήστε «0 B» για αυτόματο.',
        ...
        'default_user_quota' => 'Μορφή: ένας αριθμός ακολουθούμενος από B, KB, MB, GB ή TB (π.χ. «10GB»). Χρησιμοποιήστε «0 B» για απενεργοποίηση του ορίου.',
        ...
        'zip_bomb_max_total_size' => 'Μορφή: ένας αριθμός ακολουθούμενος από B, KB, MB, GB ή TB (π.χ. «10GB»). Προστατεύει από επιθέσεις τύπου βόμβας zip. Το αρχείο απορρίπτεται εάν το δηλωμένο ή πραγματικό μη συμπιεσμένο μέγεθός του υπερβαίνει αυτό το όριο.',
        'zip_bomb_max_file_size' => 'Μορφή: ένας αριθμός ακολουθούμενος από B, KB, MB, GB ή TB (π.χ. «5GB»). Προστατεύει από επιθέσεις τύπου βόμβας zip. Το αρχείο απορρίπτεται εάν οποιαδήποτε καταχώρηση υπερβαίνει αυτό το όριο μη συμπιεσμένη.',
        'zip_bomb_max_entries' => 'Προστατεύει από επιθέσεις άρνησης υπηρεσίας τύπου «πολλών μικρών αρχείων». Το αρχείο απορρίπτεται εάν περιέχει περισσότερες καταχωρήσεις από αυτόν τον αριθμό.',
        'zip_bomb_max_ratio' => 'Προστατεύει από επιθέσεις βόμβας zip που βασίζονται σε ακραίες αναλογίες συμπίεσης. Το αρχείο απορρίπτεται εάν η συνολική αναλογία του υπερβαίνει αυτή την τιμή.',
        'zip_bomb_delete_rejected_file' => 'Όταν είναι ενεργοποιημένο, το αρχικό αρχείο zip διαγράφεται μόλις εντοπιστεί ότι υπερβαίνει τα διαμορφωμένα όρια προστασίας από βόμβες zip. Απενεργοποιήστε το για να διατηρήσετε το αρχείο στον δίσκο για χειροκίνητο έλεγχο.',
