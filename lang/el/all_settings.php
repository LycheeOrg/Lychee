...
return [
    ...
    */
    ...
    'documentation' => [
        ...
        'nfc_share_enabled' => 'Ενεργοποίηση κοινής χρήσης της τρέχουσας διεύθυνσης URL φωτογραφίας ή άλμπουμ μέσω NFC.',
    ...
    'details' => [
        ...
        'nfc_share_enabled' => 'Όταν είναι ενεργοποιημένο και η συσκευή υποστηρίζει Web NFC, εμφανίζεται ένα κουμπί στις γραμμές κεφαλίδας φωτογραφίας και άλμπουμ για κοινή χρήση της τρέχουσας διεύθυνσης URL αγγίζοντας μια ετικέτα NFC ή άλλη συσκευή με υποστήριξη NFC.',
