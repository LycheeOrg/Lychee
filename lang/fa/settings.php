...
return [
	...
	*/
	'title' => 'تنظیمات',
	'small_screen' => 'برای تجربه بهتر در صفحه تنظیمات،<br />توصیه می‌کنیم از صفحه نمایش بزرگ‌تری استفاده کنید.',
	'tabs' => [
		'basic' => 'پایه',
	...
	'system' => [
		'header' => 'سیستم',
		'use_dark_mode' => 'استفاده از حالت تاریک برای Lychee',
		'language' => 'زبان مورد استفاده توسط Lychee',
		'nsfw_album_visibility' => 'نمایش آلبوم‌های حساس به طور پیش‌فرض.',
		...
		'cache_enabled_details' => 'این کار زمان پاسخ‌دهی Lychee را به طور قابل توجهی افزایش می‌دهد.<br> <i class="pi pi-exclamation-triangle text-warning-600 mr-2"></i>اگر از آلبوم‌های رمزدار استفاده می‌کنید، نباید این گزینه را فعال کنید.',
	],
	'lychee_se' => [
