...
return [
	...
	*/
    'title' => 'آمار',
    'preview_text' => 'این یک پیش‌نمایش از صفحه آمار موجود در Lychee <span class="text-primary-emphasis font-bold">SE</span> است.<br />داده‌های نمایش داده شده به صورت تصادفی تولید شده‌اند و منعکس‌کننده سرور شما نیستند.',
    ...
    'metrics' => [
        'header' => 'آمار زنده',
        'preview_text' => 'این یک پیش‌نمایش از آمار زنده موجود در Lychee <span class="text-primary-emphasis font-bold">SE</span> است. داده‌های نمایش داده شده به صورت تصادفی تولید شده‌اند و منعکس‌کننده سرور شما نیستند.',
