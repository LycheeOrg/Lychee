...
return [
	...
	*/
	'title' => 'نگهداری',
	'intro' => 'این صفحه به شما اجازه می‌دهد آلبوم‌های خود را به صورت دستی مرتب و اصلاح کنید.<br />قبل از هرگونه تغییر، اکیداً توصیه می‌کنیم درباره ساختار درختی Nested Set مطالعه کنید.',
	'warning' => 'در اینجا واقعاً می‌توانید نصب Lychee خود را خراب کنید، مقادیر را با مسئولیت خود تغییر دهید.',
	...
	'errors' => [
		...
		'invalid_details' => 'این تغییرات اعمال نمی‌شوند زیرا تضمین شده است که وضعیت خراب خواهد شد.',
		'invalid_left' => 'آلبوم %s مقدار چپ نامعتبر دارد.',
		'invalid_right' => 'آلبوم %s مقدار راست نامعتبر دارد.',
		'invalid_left_right' => 'آلبوم %s مقادیر چپ/راست نامعتبر دارد. مقدار چپ باید حتماً کمتر از راست باشد: %s < %s.',
