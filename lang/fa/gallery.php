    ...
    */
    ...
    'album' => [
        ...
        'properties' => [
            ...
            'autosave_hint' => 'تغییرات به‌طور خودکار ذخیره می‌شوند.',
            'expert_mode' => 'حالت حرفه‌ای',
        ],
    ],
    'photo' => [
        'actions' => [
    ...
    'menus' => [
        ...
        'search' => 'جستجو',
        'metrics' => 'آمار زنده',
        'se_preview' => 'آمار زنده (پیش‌نمایش)',
        'help' => 'میانبرهای صفحه‌کلید',
        'hide_nsfw' => 'پنهان کردن محتوای حساس',
        'show_nsfw' => 'نمایش محتوای حساس',
        'highlight' => 'ستاره‌دار',
        'unhighlight' => 'بدون ستاره',
