...
return [
    ...
    */
    ...
    'register' => [
        ...
        'expired_license' => 'Uw licentiesleutel is verlopen. Maak het veld leeg of haal een nieuwe op via <a href="https://keygen.lycheeorg.dev" class="text-primary-500 underline" target="_blank" rel="noopener noreferrer">keygen.lycheeorg.dev</a>.',
    ...
    'embed_code' => [
        'title' => 'Album insluiten',
        'title_stream' => 'Fotostroom insluiten',
        'info' => 'Genereer een insluitcode om dit album op uw website weer te geven.',
        'mode' => 'Modus',
        ...
        'max_photos' => 'Maximum aantal foto’s',
        'max_photos_none' => 'Geen (alle foto’s)',
        'max_photos_count' => '%d foto’s',
        'sort_order' => 'Sorteervolgorde',
        'sort_newest' => 'Nieuwste eerst',
        'sort_oldest' => 'Oudste eerst',
        'header_placement' => 'Plaatsing van koptekst',
        'header_top' => 'Boven',
        'header_bottom' => 'Onder',
        'header_none' => 'Geen',
        'preview' => 'Voorbeeld',
        'preview_failed' => 'Laden van voorbeeld mislukt.',
        'code' => 'Insluitcode',
        'copy' => 'Kopiëren naar klembord',
        'copied' => 'Gekopieerd!',
        'copy_success' => 'Insluitcode gekopieerd naar klembord',
        'copy_error' => 'Fout',
        'copy_error_message' => 'Kopiëren naar klembord mislukt',
        'show_advanced' => 'Geavanceerde opties tonen',
        'hide_advanced' => 'Geavanceerde opties verbergen',
    ],
    'upload' => [
        'completed' => 'Voltooid',
        'completed_with_errors' => 'Voltooid — :errors upload(s) mislukt',
        'completed_with_warnings' => 'Voltooid — :warnings upload(s) met waarschuwingen',
        'uploaded' => 'Geüpload:',
    ...
    'new_person_album' => [
        'menu' => 'Personenalbum aanmaken',
        'info' => 'Voer een titel in voor het nieuwe personenalbum:',
        'title' => 'titel',
        'set_persons' => 'Selecteer personen om toe te voegen',
        'create' => 'Personenalbum aanmaken',
    ],
    'delete_album' => [
    ...
    'photo_license' => [
        'question' => 'Selecteer een licentie voor deze foto.',
        'question_multiple' => 'Selecteer een licentie voor alle %d geselecteerde foto’s.',
        'select_license' => 'Licentie selecteren',
        'set_license' => 'Licentie instellen',
        'updated' => 'Licentie bijgewerkt!',
    ],
    'photo_copy' => [
    ...
    'selected_images' => [
        'names_copied' => 'De namen van de geselecteerde afbeeldingen zijn gekopieerd!',
    ],
    'apply_renamer' => [
        ...
        'albums' => 'Albums',
        'current' => 'Huidig',
        'descendants' => 'Onderliggende albums',
        'preview' => 'Voorbeeld',
        'preview_title' => 'Voorbeeld van wijzigingen',
        'no_changes' => 'Geen wijzigingen gedetecteerd.',
        'original' => 'Origineel',
        'new_title' => 'Nieuwe titel',
        'count_changes' => ':count item(en) worden hernoemd.',
        'back' => 'Terug',
        'apply' => 'Toepassen',
        'success' => 'Hernoemregels succesvol toegepast!',
    ],
    'watermark_confirm' => [
        'title' => 'Watermerk toepassen',
        'description' => 'Weet u zeker dat u een watermerk wilt toepassen op de foto’s in dit album? Deze actie kan niet ongedaan worden gemaakt.',
        'confirm' => 'Watermerk toepassen',
    ],
    'security_advisories' => [
        'title' => 'Beveiligingskwetsbaarheden gedetecteerd',
        'description' => 'De volgende kwetsbaarheden hebben invloed op uw huidige Lychee-versie:',
        'no_cvss' => '(geen CVSS-score)',
        'go_to_diagnostics' => 'Ga naar Diagnostiek',
    ],
];
