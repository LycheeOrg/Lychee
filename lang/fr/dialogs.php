...
return [
    ...
    */
    ...
    'register' => [
        ...
        'expired_license' => 'Votre clé de licence a expiré. Videz le champ ou obtenez-en une nouvelle sur <a href="https://keygen.lycheeorg.dev" class="text-primary-500 underline" target="_blank" rel="noopener noreferrer">keygen.lycheeorg.dev</a>.',
    ...
    'embed_code' => [
        ...
        'title_stream' => 'Intégrer le flux de photos',
        'info' => 'Générez un code d’intégration pour afficher cet album sur votre site web.',
        'mode' => 'Mode',
        ...
        'header_placement' => 'Emplacement de l’en-tête',
        'header_top' => 'Haut',
        'header_bottom' => 'Bas',
        'header_none' => 'Sans',
    ...
    'upload' => [
        'completed' => 'Terminé',
        'completed_with_errors' => 'Terminé — :errors téléversement(s) échoué(s)',
        'completed_with_warnings' => 'Terminé — :warnings téléversement(s) avec avertissement(s)',
        'uploaded' => 'Téléversé :',
    ...
    'camera' => [
        ...
        'retake' => 'Reprendre',
        'upload' => 'Téléverser',
        'secure_connection_required' => 'L\'accès à la caméra nécessite une connexion sécurisée (HTTPS ou localhost).',
    ],
    'visibility' => [
        'public' => 'Public',
    ...
    'new_person_album' => [
        'menu' => 'Créer un album de personnes',
        'info' => 'Entrez un titre pour le nouvel album de personnes :',
        'title' => 'titre',
        'set_persons' => 'Sélectionner les personnes à inclure',
        'create' => 'Créer l’album de personnes',
    ],
    'delete_album' => [
    ...
    'photo_license' => [
        'question' => 'Sélectionnez une licence pour cette photo.',
        'question_multiple' => 'Sélectionnez une licence pour les %d photos sélectionnées.',
    ...
    'selected_images' => [
        'names_copied' => 'Les noms des images sélectionnées ont été copiés !',
    ],
    'apply_renamer' => [
        ...
        'preview' => 'Aperçu',
        'preview_title' => 'Aperçu des modifications',
        'no_changes' => 'Aucune modification détectée.',
        'original' => 'Original',
        'new_title' => 'Nouveau titre',
        'count_changes' => ':count élément(s) seront renommés.',
        'back' => 'Retour',
        'apply' => 'Appliquer',
        'success' => 'Règles de renommage appliquées avec succès !',
    ],
    'watermark_confirm' => [
        'title' => 'Appliquer un filigrane',
        'description' => 'Êtes-vous sûr de vouloir appliquer un filigrane aux photos de cet album ? Cette action est irréversible.',
        'confirm' => 'Appliquer un filigrane',
    ],
    'security_advisories' => [
        'title' => 'Vulnérabilités de sécurité détectées',
        'description' => 'Les vulnérabilités suivantes affectent votre version actuelle de Lychee :',
        'no_cvss' => '(pas de score CVSS)',
        'go_to_diagnostics' => 'Aller aux diagnostics',
    ],
];
