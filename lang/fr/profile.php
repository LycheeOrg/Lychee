...
return [
    ...
    */
    ...
    'shared_albums' => [
        ...
        'mode_default' => 'Utiliser le paramètre du serveur',
        'mode_default_desc' => 'Hérite du mode de visibilité par défaut du serveur.',
        'mode_show' => 'Afficher en ligne',
        'mode_show_desc' => 'Les albums partagés apparaissent sous vos propres albums.',
        'mode_separate' => 'Onglets séparés',
        'mode_separate_desc' => 'Affiche les albums dans des onglets séparés « Mes albums » et « Partagés avec moi ».',
        'mode_separate_shared_only' => 'Partagés uniquement',
        'mode_separate_shared_only_desc' => 'Onglets séparés n’affichant que les albums partagés directement (exclut les albums publics).',
        'mode_hide' => 'Masquer',
        'mode_hide_desc' => 'N’affiche aucun album partagé.',
    ],
];
