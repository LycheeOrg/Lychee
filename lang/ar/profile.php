...
return [
    ...
    */
    ...
    'preferences' => [
        ...
        'save' => 'حفظ التفضيلات',
        'reset' => 'إعادة تعيين',
        'change_saved' => 'تم حفظ التفضيلات!',
    ],
    'shared_albums' => [
        'instruction' => 'اختر كيفية ظهور الألبومات المشتركة (الألبومات من مستخدمين آخرين) في معرضك:',
        'mode_default' => 'استخدام الإعداد الافتراضي للخادم',
        'mode_default_desc' => 'وراثة وضع الرؤية الافتراضي للخادم.',
        'mode_show' => 'عرض ضمن القائمة',
        'mode_show_desc' => 'تظهر الألبومات المشتركة أسفل ألبوماتك الخاصة.',
        'mode_separate' => 'علامات تبويب منفصلة',
        'mode_separate_desc' => 'عرض الألبومات في علامتي تبويب منفصلتين "ألبوماتي" و"المشتركة معي".',
        'mode_separate_shared_only' => 'المشتركة فقط',
        'mode_separate_shared_only_desc' => 'علامات تبويب منفصلة تعرض فقط الألبومات المشتركة مباشرة (باستثناء الألبومات العامة).',
        'mode_hide' => 'إخفاء',
        'mode_hide_desc' => 'عدم إظهار أي ألبومات مشتركة.',
    ],
];
