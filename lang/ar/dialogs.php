...
return [
    ...
    */
    ...
    'register' => [
        ...
        'expired_license' => 'انتهت صلاحية مفتاح الترخيص الخاص بك. أفرغ الحقل أو احصل على مفتاح جديد من <a href="https://keygen.lycheeorg.dev" class="text-primary-500 underline" target="_blank" rel="noopener noreferrer">keygen.lycheeorg.dev</a>.',
        'register' => 'تسجيل',
    ],
    'share_album' => [
    ...
    'embed_code' => [
        'title' => 'تضمين الألبوم',
        'title_stream' => 'تضمين تدفق الصور',
        'info' => 'أنشئ كود تضمين لعرض هذا الألبوم على موقعك الإلكتروني.',
        'mode' => 'الوضع',
        ...
        'max_photos' => 'الحد الأقصى للصور',
        'max_photos_none' => 'لا شيء (جميع الصور)',
        'max_photos_count' => '%d صورة',
        'sort_order' => 'ترتيب الفرز',
        'sort_newest' => 'الأحدث أولاً',
        'sort_oldest' => 'الأقدم أولاً',
        'header_placement' => 'موضع الرأس',
        'header_top' => 'أعلى',
        'header_bottom' => 'أسفل',
        'header_none' => 'لا شيء',
        'preview' => 'معاينة',
        'preview_failed' => 'فشل تحميل المعاينة.',
        'code' => 'كود التضمين',
        'copy' => 'نسخ إلى الحافظة',
        'copied' => 'تم النسخ!',
        'copy_success' => 'تم نسخ كود التضمين إلى الحافظة',
        'copy_error' => 'خطأ',
        'copy_error_message' => 'فشل النسخ إلى الحافظة',
        'show_advanced' => 'إظهار الخيارات المتقدمة',
        'hide_advanced' => 'إخفاء الخيارات المتقدمة',
    ],
    'upload' => [
        'completed' => 'اكتمل',
        'completed_with_errors' => 'اكتمل — فشل رفع :errors ملف/ملفات',
        'completed_with_warnings' => 'اكتمل — :warnings من عمليات الرفع تحتوي على تحذيرات',
        'uploaded' => 'تم التحميل:',
    ...
    'new_album' => [
        ...
        'title' => 'العنوان',
        'create' => 'إنشاء ألبوم',
        'visibility_private' => 'سيكون هذا الألبوم خاصًا (مرئي لك فقط)',
        'visibility_public' => 'سيكون هذا الألبوم عامًا (مرئي للجميع)',
        'visibility_public_hidden' => 'سيكون هذا الألبوم عامًا لكنه مخفي من القوائم',
        'visibility_inherit' => 'سيرث هذا الألبوم إعدادات الرؤية من الألبوم الأصل',
        'visibility_inherit_no_parent' => 'سيكون هذا الألبوم خاصًا (لا يوجد ألبوم أصل للوراثة منه)',
    ],
    'new_tag_album' => [
    ...
    'new_person_album' => [
        'menu' => 'إنشاء ألبوم شخص',
        'info' => 'أدخل عنوانًا لألبوم الشخص الجديد:',
        'title' => 'العنوان',
        'set_persons' => 'اختر الأشخاص المراد تضمينهم',
        'create' => 'إنشاء ألبوم شخص',
    ],
    'delete_album' => [
        ...
        'type_to_confirm' => 'اكتب "%s" للتأكيد.',
    ...
    'photo_tags' => [
        ...
        'existing_tags' => 'الوسوم الموجودة:',
        'partial_tags_info' => 'الوسوم الموجودة بين قوسين موجودة فقط في بعض الصور المحددة.',
    ...
    'photo_license' => [
        'question' => 'اختر ترخيصًا لهذه الصورة.',
        'question_multiple' => 'اختر ترخيصًا لجميع الصور المحددة وعددها %d.',
        'select_license' => 'اختيار الترخيص',
    ...
    'selected_images' => [
        'names_copied' => 'تم نسخ أسماء الصور المحددة!',
    ],
    'apply_renamer' => [
        'title' => 'تطبيق قواعد إعادة التسمية',
        'description' => 'اختر قواعد إعادة التسمية المراد تطبيقها وحدد نطاقها.',
        'no_rules' => 'لم يتم العثور على قواعد لإعادة التسمية.',
        'target' => 'الهدف',
        'scope' => 'النطاق',
        'photos' => 'الصور',
        'albums' => 'الألبومات',
        'current' => 'الحالي',
        'descendants' => 'الألبومات الفرعية',
        'preview' => 'معاينة',
        'preview_title' => 'معاينة التغييرات',
        'no_changes' => 'لم يتم اكتشاف أي تغييرات.',
        'original' => 'الأصلي',
        'new_title' => 'العنوان الجديد',
        'count_changes' => 'سيتم إعادة تسمية :count عنصر/عناصر.',
        'back' => 'رجوع',
        'apply' => 'تطبيق',
        'success' => 'تم تطبيق قواعد إعادة التسمية بنجاح!',
    ],
    'watermark_confirm' => [
        'title' => 'تطبيق العلامة المائية',
        'description' => 'هل أنت متأكد أنك تريد تطبيق علامة مائية على صور هذا الألبوم؟ لا يمكن التراجع عن هذا الإجراء.',
        'confirm' => 'تطبيق العلامة المائية',
    ],
    'security_advisories' => [
        'title' => 'تم اكتشاف ثغرات أمنية',
        'description' => 'تؤثر الثغرات الأمنية التالية على إصدار Lychee الحالي لديك:',
        'no_cvss' => '(لا يوجد تقييم CVSS)',
        'go_to_diagnostics' => 'الذهاب إلى التشخيصات',
    ],
];
