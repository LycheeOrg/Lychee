...
return [
    ...
    */
    ...
    'documentation' => [
        ...
        'zip_bomb_max_total_size' => '上传的 zip 归档文件解压后的最大总大小。',
        'zip_bomb_max_file_size' => '上传的 zip 归档文件中单个文件解压后的最大大小。',
        'zip_bomb_max_entries' => '上传的 zip 归档文件中允许的最大条目数。',
        'zip_bomb_max_ratio' => '上传的 zip 归档文件允许的最大压缩比(解压后/压缩后)。',
        'zip_bomb_delete_rejected_file' => '当上传的 zip 文件被判定为 zip 炸弹并被拒绝时,将其删除。',
    ...
    'details' => [
        ...
        'upload_chunk_size' => '格式:数字后跟 B、KB、MB、GB 或 TB(例如"10MB")。使用"0 B"表示自动。',
        ...
        'default_user_quota' => '格式:数字后跟 B、KB、MB、GB 或 TB(例如"10GB")。使用"0 B"可禁用配额。',
        ...
        'zip_bomb_max_total_size' => '格式:数字后跟 B、KB、MB、GB 或 TB(例如"10GB")。用于防范 zip 炸弹攻击。如果归档文件声明的或实际的解压后大小超过此限制,该归档文件将被拒绝。',
        'zip_bomb_max_file_size' => '格式:数字后跟 B、KB、MB、GB 或 TB(例如"5GB")。用于防范 zip 炸弹攻击。如果任何条目解压后超过此限制,该归档文件将被拒绝。',
        'zip_bomb_max_entries' => '用于防范"大量小文件"类型的拒绝服务攻击。如果归档文件包含的条目数超过此值,将被拒绝。',
        'zip_bomb_max_ratio' => '用于防范依赖极端压缩比的 zip 炸弹攻击。如果归档文件的整体压缩比超过此值,将被拒绝。',
        'zip_bomb_delete_rejected_file' => '启用后,一旦检测到原始 zip 文件超过配置的 zip 炸弹防护限制,该文件将立即被删除。禁用此选项可将文件保留在磁盘上以供手动检查。',
