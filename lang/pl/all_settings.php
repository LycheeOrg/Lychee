...
return [
    ...
    */
    ...
    'documentation' => [
        ...
        'upload_chunk_size' => 'Rozmiar fragmentów podczas przesyłania.',
        ...
        'zip_bomb_max_total_size' => 'Maksymalny łączny nieskompresowany rozmiar przesłanego archiwum zip.',
        'zip_bomb_max_file_size' => 'Maksymalny nieskompresowany rozmiar pojedynczego pliku w przesłanym archiwum zip.',
        'zip_bomb_max_entries' => 'Maksymalna liczba wpisów dozwolona w przesłanym archiwum zip.',
        'zip_bomb_max_ratio' => 'Maksymalny dopuszczalny współczynnik kompresji (nieskompresowany / skompresowany) przesłanego archiwum zip.',
        'zip_bomb_delete_rejected_file' => 'Usuń przesłany plik zip, gdy zostanie odrzucony jako zip bomba.',
        ...
        'expert_album_settings' => 'Domyślnie pokazuj eksperckie ustawienia albumu',
    ...
    'details' => [
        ...
        'upload_chunk_size' => 'Format: liczba, po której następuje B, KB, MB, GB lub TB (np. „10MB”). Użyj „0 B” dla trybu automatycznego.',
        ...
        'default_user_quota' => 'Format: liczba, po której następuje B, KB, MB, GB lub TB (np. „10GB”). Użyj „0 B”, aby wyłączyć limit.',
        ...
        'zip_bomb_max_total_size' => 'Format: liczba, po której następuje B, KB, MB, GB lub TB (np. „10GB”). Chroni przed atakami typu zip bomba. Archiwum zostaje odrzucone, jeśli jego zadeklarowany lub rzeczywisty nieskompresowany rozmiar przekracza ten limit.',
        'zip_bomb_max_file_size' => 'Format: liczba, po której następuje B, KB, MB, GB lub TB (np. „5GB”). Chroni przed atakami typu zip bomba. Archiwum zostaje odrzucone, jeśli jakikolwiek wpis przekracza ten limit po dekompresji.',
        'zip_bomb_max_entries' => 'Chroni przed atakami typu odmowa usługi wykorzystującymi „wiele małych plików”. Archiwum zostaje odrzucone, jeśli zawiera więcej wpisów niż ta wartość.',
        'zip_bomb_max_ratio' => 'Chroni przed atakami typu zip bomba opartymi na ekstremalnych współczynnikach kompresji. Archiwum zostaje odrzucone, jeśli jego ogólny współczynnik przekracza tę wartość.',
        'zip_bomb_delete_rejected_file' => 'Jeśli włączone, oryginalny plik zip zostaje usunięty natychmiast po wykryciu przekroczenia skonfigurowanych limitów ochrony przed zip bombami. Wyłącz, aby zachować plik na dysku do ręcznej inspekcji.',
        ...
        'expert_album_settings' => 'Po włączeniu okno ustawień albumu domyślnie pokazuje zaawansowane pola (nagłówek, licencja, prawa autorskie) zamiast ukrywać je za przełącznikiem „trybu eksperta”.',
