...
return [
    ...
    */
        ...
        'sm_pinterest_url' => 'URL des Pinterest-Profils',
        'sm_deviantart_url' => 'URL des DeviantArt-Profils',
        'sm_tumblr_url' => 'URL des Tumblr-Profils',
        'sm_500px_url' => 'URL des 500px-Profils',
        'sm_pixelfeed_url' => 'URL des Pixelfeed-Profils',
        'sm_discord_url' => 'URL des Discord-Servers',
        'sm_reddit_url' => 'URL des Reddit-Profils',
        ...
        'rss_title' => 'Titel des Feeds',
        'rss_description' => 'Beschreibung des Feeds',
        ...
        'upload_chunk_size' => 'Größe der Segmente (Chunks) beim Hochladen.',
        ...
        'landing_logo' => 'URL de la imagen del logotipo en la vista de inicio',
        ...
        'zip_bomb_max_total_size' => 'Maximale kombinierte unkomprimierte Größe eines hochgeladenen ZIP-Archivs.',
        'zip_bomb_max_file_size' => 'Maximale unkomprimierte Größe einer einzelnen Datei innerhalb eines hochgeladenen ZIP-Archivs.',
        'zip_bomb_max_entries' => 'Maximale Anzahl an Einträgen, die in einem hochgeladenen ZIP-Archiv erlaubt sind.',
        'zip_bomb_max_ratio' => 'Maximal zulässiges Kompressionsverhältnis (unkomprimiert / komprimiert) eines hochgeladenen ZIP-Archivs.',
        'zip_bomb_delete_rejected_file' => 'Die hochgeladene ZIP-Datei löschen, wenn sie als ZIP-Bombe abgelehnt wird.',
        ...
        'ai_vision_face_recognition_warning' => 'Rechtlichen Hinweis zur Gesichtserkennung anzeigen',
        'ai_vision_nsfw_enabled' => 'NSFW-Einstufung aktivieren',
        'ai_vision_nsfw_preset' => 'Voreingestellte Konfiguration für die Erkennung von nicht arbeitsgerechten Inhalten',
        'ai_vision_nsfw_check_block_action' => 'Die Suchaktion für „Benutzer überprüfen“ sperren',
        'ai_vision_nsfw_monitor_block_action' => 'Funktion zur Blocksuche für Monitor-Nutzer',
        'ai_vision_nsfw_trust_but_verify_block_action' => 'Die Suchfunktion für Benutzer sperren, die nach dem Grundsatz „Vertrauen ist gut, Kontrolle ist besser“ handeln',
        'ai_vision_nsfw_trust_block_action' => 'Block-Suchaktion für vertrauenswürdige Nutzer',
        'ai_vision_nsfw_sensitive_album_action' => 'Maßnahme zur Suche nach sensiblen Alben',
        'ai_vision_nsfw_sensitive_no_album_action' => 'Alternative Lösung für empfindliche Ergebnisse (ohne Album)',
        'ai_vision_nsfw_scan_trusted_users' => 'Vertrauenswürdige Nutzer auf Inhalte überprüfen, die nicht für die Arbeit geeignet sind',
        'ai_vision_nsfw_monitor_hide_on_scan' => 'Fotos von Monitor während der Analyse von nicht arbeitsgerechten Inhalten ausblenden',
        'ai_vision_nsfw_trust_but_verify_hide_on_scan' => 'Fotos nach dem Motto „Vertrauen ist gut, Kontrolle ist besser“ während der Analyse von nicht arbeitsgerechten Inhalten ausblenden',
        'ai_vision_nsfw_trust_hide_on_scan' => 'Vertrauenswürdige Fotos während der Analyse von nicht arbeitsgerechten Inhalten ausblenden',
        ...
        'flags_enabled' => 'Alle Flags aktivieren',
        'photo_flags_enabled' => 'Foto-Markierungen aktivieren',
        'cover_id_flag_enabled' => 'Flagge für Titelbild aktivieren',
        ...
        'header_id_flag_enabled' => 'Flag für Titelbild aktivieren',
        'highlighted_flag_enabled' => 'Markierte Foto-Flagge aktivieren',
        'validated_flag_enabled' => 'Markierung „Validiertes Foto“ aktivieren',
        'smart_album_flags_enabled' => 'Markierungen für Smart-Alben aktivieren',
        'album_flags_enabled' => 'Album-Markierungen aktivieren',
        'public_hidden_flag_enabled' => 'Flag „Öffentlich versteckt“ aktivieren',
        'public_visible_flag_enabled' => 'Flag „Für die Öffentlichkeit sichtbar“ aktivieren',
        'password_flag_enabled' => 'Passwort-Flag aktivieren',
        'sensitive_flag_enabled' => 'Flag „Vertraulich“ aktivieren',
        'expert_album_settings' => 'Erweiterte Albumeinstellungen standardmäßig anzeigen',
    ...
    'details' => [
        ...
        'rss_recent_days' => '',
        'rss_max_items' => '',
        'rss_title' => 'Dies wird als Titel des Kanals im RSS-Feed angezeigt. Lass das Feld leer, um den Standardwert zu verwenden.',
        'rss_description' => 'Wird im RSS-Feed als Kanalbeschreibung angezeigt. Lass das Feld leer, um den Standardwert zu verwenden.',
        ...
        'close_upload_on_success' => 'Wenn diese Option aktiviert ist, wird das Upload-Fenster automatisch geschlossen, sobald alle Uploads erfolgreich abgeschlossen sind. Sollte ein Upload fehlschlagen oder eine Warnung auslösen, bleibt das Fenster geöffnet.',
        'folder_upload_enabled' => 'Wenn diese Option aktiviert ist, wird beim Ziehen eines Ordners auf die Seite „Alben“ ein Album mit dem gleichen Namen wie der Ordner erstellt und dessen Inhalt hochgeladen. Unterordner werden rekursiv in Unteralben umgewandelt.',
        'folder_upload_max_depth' => '1 bedeutet nur den Hauptordner; 2 bedeutet eine Ebene mit Unterordnern; 0 bedeutet keine Begrenzung.',
        ...
        'upload_chunk_size' => 'Format: eine Zahl gefolgt von B, KB, MB, GB oder TB (z. B. „10MB“). „0 B“ für automatisch verwenden.',
        ...
        'default_user_quota' => 'Format: eine Zahl gefolgt von B, KB, MB, GB oder TB (z. B. „10GB“). „0 B“ verwenden, um das Kontingent zu deaktivieren.',
        ...
        'hide_nsfw_in_smart_albums' => 'Die Bilder aus den „Sensitive“-Alben werden in den „Smart“-Alben nicht angezeigt.',
        'hide_nsfw_in_frame' => 'Die Bilder aus den sensiblen Alben werden im Rahmen nicht angezeigt.',
        'hide_nsfw_in_map' => 'Die Bilder aus den vertraulichen Alben werden auf der Karte nicht angezeigt.',
        'hide_nsfw_in_search' => 'Bilder aus Alben, die als „sensibel“ eingestuft sind, werden in den Suchergebnissen nicht angezeigt.',
        ...
        'site_logo' => 'Wenn diese Option aktiviert ist, wird der Titeltext der Webseite in der Kopfzeile der Galerie ersetzt.',
        'landing_logo' => 'Wenn diese Option aktiviert ist, wird der Text der Überschrift und der Unterüberschrift der Zielseite, die in der Einleitung angezeigt wird, ersetzt.',
        'landing_header_logo' => 'Wenn diese Funktion aktiviert ist, ersetzt sie den Titel und den Untertitel der Zielseite, die in der oberen linken Ecke der Seite angezeigt werden.',
        ...
        'hide_nsfw_in_tag_albums' => 'Bilder aus sensiblen Alben werden in den Tag-Alben nicht angezeigt.',
        'hide_nsfw_in_tag_listing' => 'Bilder aus Alben mit sensiblen Inhalten werden nicht in der Fotoliste eines Tags angezeigt.',
        ...
        'PA_override_searchability' => '<span class="pi pi-exclamation-triangle text-orange-500"></span> Wenn diese Option aktiviert ist, werden Fotos von Personen, die nicht gesucht werden können, weiterhin in den Personenalben angezeigt. Wenn diese Option deaktiviert ist, tragen Personen, die nicht gesucht werden können, keine Fotos mehr zu den Personenalben bei.',
        ...
        'zip_bomb_max_total_size' => 'Format: eine Zahl gefolgt von B, KB, MB, GB oder TB (z. B. „10GB“). Schützt vor ZIP-Bomben-Angriffen. Das Archiv wird abgelehnt, wenn seine angegebene oder tatsächliche unkomprimierte Größe dieses Limit überschreitet.',
        'zip_bomb_max_file_size' => 'Format: eine Zahl gefolgt von B, KB, MB, GB oder TB (z. B. „5GB“). Schützt vor ZIP-Bomben-Angriffen. Das Archiv wird abgelehnt, wenn ein einzelner Eintrag unkomprimiert dieses Limit überschreitet.',
        'zip_bomb_max_entries' => 'Schützt vor Denial-of-Service-Angriffen durch „viele kleine Dateien“. Das Archiv wird abgelehnt, wenn es mehr Einträge als angegeben enthält.',
        'zip_bomb_max_ratio' => 'Schützt vor ZIP-Bomben-Angriffen, die auf extremen Kompressionsverhältnissen beruhen. Das Archiv wird abgelehnt, wenn sein Gesamtverhältnis diesen Wert überschreitet.',
        'zip_bomb_delete_rejected_file' => 'Wenn aktiviert, wird die ursprüngliche ZIP-Datei sofort gelöscht, sobald festgestellt wird, dass sie die konfigurierten ZIP-Bomben-Schutzgrenzen überschreitet. Deaktivieren, um die Datei zur manuellen Prüfung auf dem Server zu behalten.',
        ...
        'ai_vision_face_recognition_warning' => 'Wenn diese Funktion aktiviert ist, wird auf den Seiten „Gesichtsgruppen“ und „Gesichtsverwaltung“ ein rechtlicher Hinweis zur Gesichtserkennung angezeigt. Ein Administrator kann diesen Hinweis schließen.',
        'ai_vision_nsfw_enabled' => 'Wenn diese Funktion zusammen mit dem globalen AI-Vision-Schalter aktiviert wird, werden hochgeladene Fotos automatisch über den externen Bewertungsdienst auf NSFW-Inhalte überprüft.',
        'ai_vision_nsfw_preset' => 'An den NSFW-Klassifikator übermittelte Erkennungseinstellungen. Hiermit werden die Empfindlichkeit sowie die Tags gesteuert, die Maßnahmen wie Sperrung, Überprüfung oder Kennzeichnung als sensibler Inhalt auslösen.',
        'ai_vision_nsfw_check_block_action' => 'Diese Maßnahme wird ergriffen, wenn in einem Foto eines Nutzers mit der Vertrauensstufe „Check“ NSFW-Inhalte der Stufe „Sperren“ festgestellt werden. Die Option „Sperren“ löscht das Foto dauerhaft; die Option „Moderieren“ hält es zurück, damit es von einem Administrator überprüft werden kann.',
        'ai_vision_nsfw_monitor_block_action' => 'Maßnahmen, die zu ergreifen sind, wenn in einem Foto eines Nutzers mit der Vertrauensstufe „Monitor“ NSFW-Inhalte der Stufe „Sperre“ festgestellt werden.',
        'ai_vision_nsfw_trust_but_verify_block_action' => 'Maßnahmen, die zu ergreifen sind, wenn in einem Foto eines Nutzers mit der Vertrauensstufe „Vertrauen, aber überprüfen“ NSFW-Inhalte der Stufe „Sperre“ festgestellt werden.',
        'ai_vision_nsfw_trust_block_action' => 'Maßnahme, die ergriffen wird, wenn in einem Foto eines vertrauenswürdigen Nutzers NSFW-Inhalte der Stufe „Sperre“ erkannt werden. „Freigeben“ bedeutet, dass das Ergebnis der Analyse protokolliert wird, jedoch keine Maßnahmen ergriffen werden.',
        'ai_vision_nsfw_sensitive_album_action' => 'Wenn die als „sensibel“ und „NSFW“ eingestuften Ergebnisse dazu führen, dass das Fotoalbum bzw. die Fotoalben als „NSFW“ gekennzeichnet werden.',
        'ai_vision_nsfw_sensitive_no_album_action' => 'Alternative Lösung, wenn bei einem nicht klassifizierten Foto ohne Album eine Warnung wegen sensibler Inhalte ausgelöst wird. Die Option „Überspringen“ protokolliert eine Warnung; die Option „Moderieren“ hält das Foto zurück, damit es von einem Administrator überprüft werden kann.',
        'ai_vision_nsfw_scan_trusted_users' => 'Werden die von vertrauenswürdigen Nutzern hochgeladenen Fotos ebenfalls auf nicht arbeitsgerechte Inhalte (NSFW) überprüft?',
        'ai_vision_nsfw_monitor_hide_on_scan' => 'Fotos der Stufe „Monitor“ vorübergehend ausblenden, während die NSFW-Analyse durchgeführt wird.<br> <span class="pi pi-exclamation-triangle text-orange-500"></span> Wenn der Klassifizierer nicht verfügbar ist, bleibt das Foto ausgeblendet, bis es manuell freigegeben wird.',
        'ai_vision_nsfw_trust_but_verify_hide_on_scan' => 'Fotos aus „Vertrauen ist gut, Kontrolle ist besser“ vorübergehend ausblenden, während die Analyse auf nicht arbeitsplatztaugliche Inhalte (NSFW) durchgeführt wird.<br> <span class="pi pi-exclamation-triangle text-orange-500"></span> Ist der Klassifizierer nicht verfügbar, bleibt das Foto so lange ausgeblendet, bis es manuell freigegeben wird.',
        'ai_vision_nsfw_trust_hide_on_scan' => 'Vertrauliche Fotos vorübergehend ausblenden, während die Analyse von nicht arbeitsgerechten Inhalten (NSFW) durchgeführt wird.<br> <span class="pi pi-exclamation-triangle text-orange-500"></span> Ist der Klassifikator nicht verfügbar, bleibt das Foto so lange ausgeblendet, bis es manuell freigegeben wird.',
        ...
        'flags_enabled' => 'Hauptschalter für alle Status-Symbole, die auf Album- und Foto-Miniaturansichten angezeigt werden (öffentlich, versteckt, passwortgeschützt, vertraulich, hervorgehoben, Symbole für Smart-Alben). Wenn Sie diesen Schalter deaktivieren, werden alle Symbole ausgeblendet, unabhängig von den untenstehenden Einstellungen.',
        'photo_flags_enabled' => 'Zeige die Markierungen für „Titelbild“, „Kopfzeile“, „Hervorgehoben“ und „Nicht validiert“ auf den Foto-Miniaturansichten an. Wenn du diese Option deaktivierst, werden alle diese Markierungen ausgeblendet, unabhängig von den untenstehenden Einstellungen.',
        'cover_id_flag_enabled' => 'Zeige das Cover-Logo auf dem Foto an, das derzeit als Albumcover verwendet wird.',
        ...
        'header_id_flag_enabled' => 'Zeige das Header-Symbol auf dem Foto an, das derzeit als Album-Header verwendet wird.',
        'highlighted_flag_enabled' => 'Die markierte Flagge auf den Foto-Miniaturansichten anzeigen.',
        'validated_flag_enabled' => 'Zeige das Flag „Nicht validiert“ auf den Foto-Miniaturansichten an.',
        'smart_album_flags_enabled' => 'Die Symbole für Smart-Alben („Unsortiert“, „Zuletzt angesehen“, „An diesem Tag“, „Bewertungen“ usw.) auf den Miniaturansichten der Smart-Alben anzeigen.',
        'album_flags_enabled' => 'Zeige die Markierungen „öffentlich“, „verborgen“, „Passwortgeschützt“ und „vertraulich“ auf den Miniaturansichten regulärer (nicht intelligenter) Alben an.',
        'public_hidden_flag_enabled' => 'Zeige das orangefarbene Augensymbol bei Alben an, auf die nur über einen freigegebenen Link zugegriffen werden kann (die in der öffentlichen Galerie ausgeblendet sind).',
        'public_visible_flag_enabled' => 'Zeige das grüne Augensymbol bei öffentlich sichtbaren Alben an.',
        'password_flag_enabled' => 'Das Schloss-Symbol bei passwortgeschützten Alben anzeigen.',
        'sensitive_flag_enabled' => 'Zeige das Warnsymbol bei Alben an, die als nicht jugendfrei (NSFW) gekennzeichnet sind.',
        'expert_album_settings' => 'Wenn aktiviert, zeigt der Album-Einstellungsdialog die erweiterten Felder (Kopfzeile, Lizenz, Urheberrecht) standardmäßig an, anstatt sie hinter dem „Expertenmodus“-Schalter zu verstecken.',
    ...
    'category_description' => [
        ...
        'Gallery' => '',
        'Mod Welcome' => 'Dieses Modul aktiviert eine Landingpage. Statt direkt in der Galerieansicht zu landen, verleiht sie dem Eingang Ihrer Website etwas mehr Glanz. Geben Sie die URL des anzuzeigenden Bildes an und legen Sie den Titel fest. Wir empfehlen, die Landing-Page-Erweiterung zu verwenden, die im Admin-Dashboard verfügbar ist, anstelle dieser einzelnen Optionen, da sie eine Live-Vorschau Ihrer Änderungen bietet.',
        'Footer' => '',
        'Smart Albums' => '',
        'Image Processing' => '',
        'Mod Search' => '',
        ...
        'AI Vision' => 'KI-gestützte Funktionen, darunter Gesichtserkennung und Erkennung von nicht jugendfreien Inhalten. Erfordert einen externen „AI Vision“-Sidecar-Dienst.',
