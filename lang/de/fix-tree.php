...
return [
    ...
    */
    ...
    'errors' => [
        ...
        'invalid_right' => 'Album %s hat einen ungültigen rechten Wert.',
        'invalid_left_right' => 'Album %s hat einen ungültigen Links/Rechts-Wert. Links sollte deutlich kleiner sein als rechts: %s < %s.',
        'duplicate_left' => 'Album %s hat einen doppelten linken Wert %s.',
        'duplicate_right' => 'Album %s hat einen doppelten rechten Wert %s.',
