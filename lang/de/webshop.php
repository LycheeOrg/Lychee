...
return [
    ...
    */
    ...
    'orderDownload' => [
        ...
        'enterTrackingUrl' => 'Sendungsverfolgungscode oder URL eingeben',
        'download' => 'Download',
        'downloadNotAvailable' => 'Download (noch) nicht verfügbar',
        'trackShipment' => 'Sendung verfolgen',
        'awaitingShipment' => 'Wartet auf Versand',
    ...
    'sizeCatalogue' => [
        'title' => 'Size Catalogue',
        'printSizes' => 'Print Sizes',
        'pixelSizes' => 'Pixel Sizes',
        'addPrintSize' => 'Add Print Size',
        'addPixelSize' => 'Add Pixel Size',
        'editPrintSize' => 'Edit Print Size',
        'editPixelSize' => 'Edit Pixel Size',
        'label' => 'Label',
        ...
        'confirmDeleteMessage' => 'Are you sure you want to delete this size? Existing orders will not be affected.',
        'error' => 'Error',
    ],
    'printSizePricesInput' => [
        'title' => 'Print Size Prices',
        'selectSize' => 'Select Print Size',
        'addSize' => 'Add Print Size Price',
    ],
    'pixelSizePricesInput' => [
        'title' => 'Pixel Size Prices',
        'selectSize' => 'Select Pixel Size',
        'addSize' => 'Add Pixel Size Price',
    ],
    'shippingAddress' => [
        'title' => 'Shipping Address',
        'required' => 'Your order contains print items. Please provide a shipping address.',
