...
return [
    ...
    */
    ...
    'documentation' => [
        ...
        'compression_quality' => 'Quality of generated size variants',
        ...
        'upload_chunk_size' => 'Size of chunks when uploading.',
        ...
        'zip_bomb_max_total_size' => 'Maximum combined uncompressed size of an uploaded zip archive.',
        'zip_bomb_max_file_size' => 'Maximum uncompressed size of any single file within an uploaded zip archive.',
        'zip_bomb_max_entries' => 'Maximum number of entries allowed in an uploaded zip archive.',
        'zip_bomb_max_ratio' => 'Maximum allowed compression ratio (uncompressed / compressed) of an uploaded zip archive.',
        'zip_bomb_delete_rejected_file' => 'Delete the uploaded zip file when it is rejected as a zip bomb.',
    ...
    'details' => [
        ...
        'mod_frame_refresh' => '',
        'image_overlay_type' => '',
        'compression_quality' => '1-100: lossy quality. 0: lossless for WebP, maximum quality (100) for formats without a lossless mode such as JPEG.',
        'landing_page_enable' => '',
        'site_owner' => '',
        'landing_title' => '',
        'landing_subtitle' => '',
        ...
        'upload_chunk_size' => 'Format: a number followed by B, KB, MB, GB or TB (e.g. "10MB"). Use "0 B" for auto.',
        ...
        'default_user_quota' => 'Format: a number followed by B, KB, MB, GB or TB (e.g. "10GB"). Use "0 B" to disable the quota.',
        ...
        'zip_bomb_max_total_size' => 'Format: a number followed by B, KB, MB, GB or TB (e.g. "10GB"). Protects against zip-bomb attacks. The archive is rejected if its declared or actual uncompressed size exceeds this limit.',
        'zip_bomb_max_file_size' => 'Format: a number followed by B, KB, MB, GB or TB (e.g. "5GB"). Protects against zip-bomb attacks. The archive is rejected if any single entry exceeds this limit when uncompressed.',
        'zip_bomb_max_entries' => 'Protects against "many tiny files" denial-of-service attacks. The archive is rejected if it contains more entries than this.',
        'zip_bomb_max_ratio' => 'Protects against zip-bomb attacks that rely on extreme compression ratios. The archive is rejected if its overall ratio exceeds this value.',
        'zip_bomb_delete_rejected_file' => 'When enabled, the original zip file is deleted as soon as it is detected as exceeding the configured zip-bomb protection limits. Disable to keep the file on disk for manual inspection.',
