...
return [
    ...
    */
    ...
    'metrics' => [
        'header' => 'Live metrics',
        'preview_text' => 'Это предварительный просмотр страницы статистики, доступной в Lychee <span class="text-primary-emphasis font-bold">SE</span>. Приведенные здесь данные генерируются случайным образом и не отражают состояние вашего сервера.',
