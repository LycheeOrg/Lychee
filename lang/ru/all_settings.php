...
return [
    ...
    */
    ...
    'documentation' => [
        ...
        'upload_chunk_size' => 'Размер частей при загрузке.',
        ...
        'size_variant_format' => 'Формат генерируемых миниатюр',
        ...
        'zip_bomb_max_total_size' => 'Максимальный суммарный несжатый размер загруженного zip-архива.',
        'zip_bomb_max_file_size' => 'Максимальный несжатый размер одного файла внутри загруженного zip-архива.',
        'zip_bomb_max_entries' => 'Максимальное количество записей, допустимое в загруженном zip-архиве.',
        'zip_bomb_max_ratio' => 'Максимально допустимая степень сжатия (несжатый / сжатый) загруженного zip-архива.',
        'zip_bomb_delete_rejected_file' => 'Удалять загруженный zip-файл, если он отклонён как zip-бомба.',
        ...
        'expert_album_settings' => 'Показывать экспертные настройки альбома по умолчанию',
    ...
    'details' => [
        ...
        'upload_chunk_size' => 'Формат: число, за которым следует B, KB, MB, GB или TB (например, «10MB»). Используйте «0 B» для автоматического режима.',
        ...
        'default_user_quota' => 'Формат: число, за которым следует B, KB, MB, GB или TB (например, «10GB»). Используйте «0 B», чтобы отключить квоту.',
        ...
        'size_variant_format' => 'Original: thumb в JPEG, small и medium в формате загруженного файла. JPEG или WebP: все генерируемые миниатюры в этом формате. Действует только на вновь создаваемые миниатюры.',
        ...
        'zip_bomb_max_total_size' => 'Формат: число, за которым следует B, KB, MB, GB или TB (например, «10GB»). Защищает от атак типа zip-бомба. Архив отклоняется, если его заявленный или фактический несжатый размер превышает этот предел.',
        'zip_bomb_max_file_size' => 'Формат: число, за которым следует B, KB, MB, GB или TB (например, «5GB»). Защищает от атак типа zip-бомба. Архив отклоняется, если любая запись превышает этот предел в несжатом виде.',
        'zip_bomb_max_entries' => 'Защищает от атак типа «отказ в обслуживании» с использованием «множества мелких файлов». Архив отклоняется, если он содержит больше записей, чем указано.',
        'zip_bomb_max_ratio' => 'Защищает от атак типа zip-бомба, основанных на экстремальной степени сжатия. Архив отклоняется, если его общая степень сжатия превышает это значение.',
        'zip_bomb_delete_rejected_file' => 'Если включено, исходный zip-файл удаляется сразу после обнаружения превышения настроенных лимитов защиты от zip-бомб. Отключите, чтобы сохранить файл на диске для ручной проверки.',
        ...
        'expert_album_settings' => 'Если включено, диалог настроек альбома по умолчанию показывает расширенные поля (заголовок, лицензия, авторские права), вместо того чтобы скрывать их за переключателем «режим эксперта».',
