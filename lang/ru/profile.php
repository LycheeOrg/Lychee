...
return [
    ...
    */
    ...
    'admin_setup' => [
        'header' => 'Настройте учетную запись администратора',
        'welcome' => 'Добро пожаловать в Lychee.<br>Начнём с создания учётной записи администратора.',
        'submit' => 'Создать учетную запись администратора',
        'success' => 'Учетная запись администратора успешно создана.',
        'error' => 'Произошла ошибка при создании учетной записи администратора.',
        'already_exists' => 'Учетная запись администратора уже настроена.',
    ],
    'token' => [
