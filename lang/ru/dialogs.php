...
return [
    ...
    */
    ...
    'photo_tags' => [
        ...
        'no_tags' => 'Нет тегов',
        'existing_tags' => 'Уже установленные теги:',
        'partial_tags_info' => 'Теги в скобках присутствуют только на некоторых из выбранных фотографий.',
