...
/**
 * FacePermissionMode::PRIVATE — logged-in users only for most operations.
 *
 * Expected behaviour per operation:
 *   View People page   → logged users
 *   View face overlays → logged users
 ...
 *   View album people  → logged users
 */
class PrivateModeTest extends BaseApiWithDataTest
{
	...
	public function testViewFaceOverlaysGateLoggedOwnerAllowed(): void
	{
		$this->actingAs($this->userMayUpload1);
		$this->assertTrue(Gate::check(PhotoPolicy::CAN_VIEW_FACE_OVERLAYS, $this->photo1));
	}

	public function testViewFaceOverlaysGateLoggedNonOwnerAllowed(): void
	{
		$this->actingAs($this->userMayUpload2);
		$this->assertTrue(Gate::check(PhotoPolicy::CAN_VIEW_FACE_OVERLAYS, $this->photo1));
	}

	public function testViewFaceOverlaysGateLoggedNoAccessUserAllowed(): void
	{
	...
	public function testAssignFaceGateOwnerAllowed(): void
	{
		$this->actingAs($this->userMayUpload1);
	...
	public function testAssignFaceGateAlbumLoggedAllowed(): void
	{
		$this->actingAs($this->userMayUpload2);
	...
	public function testTriggerScanGateAlbumLoggedAllowed(): void
	{
		$this->actingAs($this->userMayUpload2);
	...
	public function testBatchFaceOpsGateLoggedAllowed(): void
	{
		$this->actingAs($this->userMayUpload1);
	...
	public function testViewAlbumPeopleGateLoggedNonOwnerAllowed(): void
	{
		$this->actingAs($this->userMayUpload2);
		$this->assertTrue(Gate::check(AlbumPolicy::CAN_VIEW_ALBUM_PEOPLE, [AbstractAlbum::class, $this->album1]));
	}

	public function testViewAlbumPeopleGateLoggedNoAccessAllowed(): void
	{
		$this->actingAs($this->userNoUpload);
		$this->assertTrue(Gate::check(AlbumPolicy::CAN_VIEW_ALBUM_PEOPLE, [AbstractAlbum::class, $this->album1]));
	}
	...
	public function testViewAlbumPeopleHttpLoggedAllowed(): void
	{
