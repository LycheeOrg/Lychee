...
class SharingSpecialTest extends SharingTestBase
{
	...
	protected function prepareSixAlbumsWithDifferentProtectionSettings(): void
	{
		...
		$this->albums_tests->set_protection_policies(id: $this->albumID3, password: self::ALBUM_PWD_1);
		$this->albums_tests->set_protection_policies(id: $this->albumID4, requiresLink: true, password: self::ALBUM_PWD_1);
		$this->albums_tests->set_protection_policies(id: $this->albumID5, password: self::ALBUM_PWD_2);
		$this->albums_tests->set_protection_policies(id: $this->albumID6, requiresLink: true, password: self::ALBUM_PWD_2);
