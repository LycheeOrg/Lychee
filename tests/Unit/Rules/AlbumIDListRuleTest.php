...
class AlbumIDListRuleTest extends AbstractTestCase
{
	public function testNegative(): void
	{
		...
		$expected = ':attribute must be a comma-separated string of strings with either ' .
			RandomID::ID_LENGTH . ' characters each or one of the built-in IDs unsorted, starred, recent, on_this_day, untagged, unrated, one_star, two_stars, three_stars, four_stars, five_stars, best_pictures';
