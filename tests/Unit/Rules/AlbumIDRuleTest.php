...
class AlbumIDRuleTest extends AbstractTestCase
{
	public function testNegative(): void
	{
		...
		$expected = ':attribute must be a string with ' .
			RandomID::ID_LENGTH . ' characters or one of the built-in IDs unsorted, starred, recent, on_this_day, untagged, unrated, one_star, two_stars, three_stars, four_stars, five_stars, best_pictures';
