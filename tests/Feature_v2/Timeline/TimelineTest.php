...
class TimelineTest extends BaseApiWithDataTest
{
	...
	public function testAuthorizedPublic(): void
	{
		...
		$response = $this->getJsonWithData('Timeline::dates', ['date' => '2021-01-01']);
		$this->assertOk($response);

		$response = $this->getJsonWithData('Timeline::dates', ['photoId' => $this->photo1->id]);
		$this->assertOk($response);
