...
final class Italian implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'DELETE_ALBUM_CONFIRMATION' => 'Sei sicuro di voler eliminare l\' album \'%0\' e tutte le immagini che contiene? Questa azione non può essere annullata successivamente!',

			'DELETE_ALBUMS_QUESTION' => 'Elimina gli Album e le Immagini',
			'KEEP_ALBUMS' => 'Mantieni gli Album',
			'DELETE_ALBUMS_CONFIRMATION' => 'Sei sicuro di voler eliminare tutti %0 gli album selezionati e le immagini contenute in essi? Questa azione non può essere annullata successivamente!',
			...
			'ALBUMS_NEW_TITLE' => 'Inserire un nuovo titolo per %0 gli album selezionati:',
			...
			'ALBUM_MERGE' => 'Sei sicuro di voler unire l\'album \'%0\' nell\' album \'%1\'?',
			'ALBUMS_MERGE' => 'Sei sicuro di voler unire tutti gli album selezionati nell\'album \'%0\'?',
			'MERGE_ALBUM' => 'Unisci Album',
			'DONT_MERGE' => 'Non Unire',
			'ALBUM_MOVE' => 'Sei sicuro di voler spostare l\' album \'%0\' nell\' album \'%1\'?',
			...
			'PHOTOS_NEW_TAGS' => 'Inserisci i tuoi tag per tutte %0 le foto selezionate. I tag esistenti verrano sovrascritti. Puoi aggiungere più tag separandoli con una virgola:',
			...
			'PHOTO_DELETE_CONFIRMATION' => 'Sei sicuro di voler eliminare la foto \'%0\'? Questa operazione non può essere annullata successivamente!',
			'PHOTO_DELETE_ALL' => 'Sei sicuro di voler eliminare tutte le %0 foto selezionate? Questa operazione non può essere annullata successivamente!',
			'PHOTO_NEW_TITLE' => 'Inserisci un nuovo titolo per questa foto:',
			'PHOTOS_NEW_TITLE_' => 'Inserisci un titolo per tutte le %0 foto selezionate:',
			...
			'SORT_ALBUM_BY' => 'Ordina album per %0 in un ordine %1.',
			...
			'SORT_PHOTO_BY' => 'Ordina foto per %0 in un ordine %1.',
			...
			'ABOUT_DESCRIPTION' => '<a target=\'_blank\' href=\'%0\'>Lychee</a> è uno strumento gratuito di gestione delle foto, eseguito nel server o sul tuo spazio web. L\'installazione è questione di secondi. Carica, gestisci e condividi foto come in un\'applicazione nativa. Lychee offre tutto ciò di cui hai bisogno e tutte le tue foto vengono salvate in modo sicuro.',
			'FOOTER_COPYRIGHT' => 'Tutte le immagini su questo sito web sono soggette a Copyright di %0 &copy; %1',
