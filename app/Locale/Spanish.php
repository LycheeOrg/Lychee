...
final class Spanish implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'DELETE_ALBUM_CONFIRMATION' => '¿Estás seguro de que deseas eliminar el álbum? \'%0\' ¿Ha seleccionado un álbum y todas las fotos que contiene? ¡Esta acción no se puede deshacer!',

			'DELETE_ALBUMS_QUESTION' => 'Eliminar Álbumes y Fotos',
			'KEEP_ALBUMS' => 'Mantener Álbumes',
			'DELETE_ALBUMS_CONFIRMATION' => '¿Está seguro de que desea eliminar todo %0 Ha seleccionado álbumes y todas las fotos que contienen? ¡Esta acción no se puede deshacer!',
			...
			'ALBUMS_NEW_TITLE' => 'Ingrese un título para todos %0 álbumes seleccionados:',
			...
			'ALBUM_MERGE' => '¿Estás seguro de que quieres fusionar el álbum \'%0\' en el álbum \'%1\'?',
			'ALBUMS_MERGE' => '¿Está seguro de que desea fusionar todos los álbumes seleccionados en el álbum \'%0\'?',
			'MERGE_ALBUM' => 'Fusionar álbumes',
			'DONT_MERGE' => 'No combinar',
			'ALBUM_MOVE' => '¿Estás seguro de que quieres mover el álbum \'%0\' detro del álbum \'%1\'?',
			...
			'PHOTOS_NEW_TAGS' => 'Ingrese sus etiquetas para todos %0 fotos seleccionadas. Las etiquetas existentes se sobrescribirán. Puede agregar varias etiquetas separándolas con una coma:',
			...
			'PHOTO_DELETE_CONFIRMATION' => '¿Estás seguro de que deseas eliminar la foto \'%0\'? ¡Esta acción no se puede deshacer!',
			'PHOTO_DELETE_ALL' => '¿Está seguro de que desea eliminar todo %0 foto seleccionada? ¡Esta acción no se puede deshacer!',
			'PHOTOS_NEW_TITLE_' => 'Ingrese un título para todos %0 fotos seleccionadas:',
			...
			'SORT_ALBUM_BY' => 'Ordenar álbumes por %0 en un %1 orden.',
			...
			'SORT_PHOTO_BY' => 'Ordenar fotos por %0 en un %1 orden.',
			...
			'ABOUT_DESCRIPTION' => '<a target=\'_blank\' href=\'%0\'>Lychee</a> es una herramienta gratuita de gestión de fotos, que se ejecuta en su servidor o espacio web. La instalación es cuestión de segundos. Cargue, administre y comparta fotos como desde una aplicación nativa. Lychee viene con todo lo que necesitas y todas tus fotos se almacenan de forma segura.',
			'FOOTER_COPYRIGHT' => 'Todas las imágenes de este sitio web están sujetas a Copyright por %0 &copy; %1',
