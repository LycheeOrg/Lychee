...
final class Spanish implements Language
{
	...
	public function get_locale(): array
	{
		return [
			...
			'ALBUM_DECORATION_NONE' => 'No decorations',
			'ALBUM_DECORATION_ORIGINAL' => 'Sub-album badge, no counts',
			'ALBUM_DECORATION_ALBUM' => 'Sub-album badge with counts',
			'ALBUM_DECORATION_PHOTO' => 'Badge with photo counts',
			'ALBUM_DECORATION_ALL' => 'Sub-album and photo counts',
			...
			'ALBUM_DECORATION_ORIENTATION_COLUMN' => 'Vertical decorations (top albums, photos)',
			'ALBUM_DECORATION_ORIENTATION_COLUMN_REVERSE' => 'Vertical decorations (top photos, albums)',
			...
			'RESTRICTED_ACCOUNT' => 'Cuenta restringida',
