...
final class Swedish implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'DELETE_ALBUM_CONFIRMATION' => 'Är du säker på att du vill radera albumet \'%0\' och alla fotografier det innehåller? Raderingen går inte att ångra!',

			'DELETE_ALBUMS_QUESTION' => 'Radera album och fotografier',
			'KEEP_ALBUMS' => 'Behåll album',
			'DELETE_ALBUMS_CONFIRMATION' => 'Är du säker på att du vill radera alla %0 valda album och alla fotografier de innehåller? Raderingen går inte att ångra!',
			...
			'ALBUMS_NEW_TITLE' => 'Skriv en ny titel för alla %0 valda album:',
			...
			'ALBUM_MERGE' => 'Är du säker på att du vill sammanfoga albumet \'%0\' med albumet \'%1\'?',
			'ALBUMS_MERGE' => 'Är du säker på att du vill sammanfoga samtliga valda album till albumet \'%0\'?',
			...
			'PHOTOS_NEW_TAGS' => 'Ange kategori för samtliga valda bilder %0 Befintliga kategorier kommer att raderas. Du kan lägga till nya kategorier genom att separera dem med kommatecken:',
			...
			'PHOTO_DELETE_CONFIRMATION' => 'Är du säker på att du vill radera det här fotografiet? \'%0\' Raderingen går inte att ångra!',
			'PHOTO_DELETE_ALL' => 'Är du säker på att du vill radera alla %0 valda fotografier? Raderingen går inte att ångra!',
			'PHOTOS_NEW_TITLE_' => 'Ange en tital för alla %0 valda fotografier:',
			...
			'SORT_ALBUM_BY' => 'Sortera album efter %0 i en %1 ordning.',
			...
			'SORT_PHOTO_BY' => 'Sortera fotografier efter',
			...
			'FOOTER_COPYRIGHT' => 'Alla bilder på denna webbplats är föremål för upphovsrätt från %0 &copy; %1',
