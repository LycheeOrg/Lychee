...
final class NorwegianBokmal implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'DELETE_ALBUM_CONFIRMATION' => 'Ønsker du virkelig å fjerne album \'%0\' og alle bildene i det? Denne handlingen kan ikke angres!',

			'DELETE_ALBUMS_QUESTION' => 'Fjern Album og Bilder',
			'KEEP_ALBUMS' => 'Behold Album',
			'DELETE_ALBUMS_CONFIRMATION' => 'Ønsker du virkelig å fjerne %0 valgte album og alle bildene i disse? Denne handlingen kan ikke angres!',
			...
			'ALBUMS_NEW_TITLE' => 'Legg inn en ny tittel for %0 valgte album:',
			...
			'ALBUM_MERGE' => 'Ønsker du virkelig slå sammen album \'%0\' med album \'%1\'?',
			'ALBUMS_MERGE' => 'Ønsker du virkelig å slå sammen alle valge album til albumet \'%0\'?',
			'MERGE_ALBUM' => 'Slå sammen Album',
			'DONT_MERGE' => 'Ikke slå sammen',
			'ALBUM_MOVE' => 'Ønsker du virkelig å flytte album \'%0\' inn i album \'%1\'?',
			...
			'PHOTOS_NEW_TAGS' => 'Legg inn tagger for %0 valgte bilder. Tagger vil bli overskrevet. Du kan legge inn flere tagger ved å dele de med komma',
			...
			'PHOTO_DELETE_CONFIRMATION' => 'Ønsker du virkelig å fjerne bilde \'%0\'? Denne handlingen kan ikke angres!',
			'PHOTO_DELETE_ALL' => 'Ønsker du virkelig å fjerne %0 valgte bilder? Denne handlingen kan ikke angres!',
			'PHOTOS_NEW_TITLE_' => 'Fyll inn en tittel for %0 valgte bilder:',
			...
			'SORT_ALBUM_BY' => 'Sorter album etter %0 i en %1 rekkefølge.',
			...
			'SORT_PHOTO_BY' => 'Sorter bilder etter %0 i en %1 rekkefølge.',
			...
			'ABOUT_DESCRIPTION' => '<a target=\'_blank\' href=\'%0\'>Lychee</a> er et gratis bildehåndteringsverktøy, som kjører på serveren eller en webhost som du eier og kontrollerer. Installasjon tar sekunder. Last opp, håndter, og del bilder som om det er din egen maskin. Lychee leverer alt du trenger, og alle bildene er trygt lagret.',
			'FOOTER_COPYRIGHT' => 'Alle bildene på denne nettsiden er bundet av opphavsrett fra %0 &copy; %1',
