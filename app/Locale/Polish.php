...
final class Polish implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'DELETE_ALBUM_CONFIRMATION' => 'Czy na pewno chcesz usunąć album \'%0\' razem z zawartością ? Ta akcja jest nieodwracalna!',

			'DELETE_ALBUMS_QUESTION' => 'Usuń album wraz z zawartością',
			'KEEP_ALBUMS' => 'Zatrzymaj Albumy',
			'DELETE_ALBUMS_CONFIRMATION' => 'Czy na pewno usunąć %0 zaznaczone albumy wraz z zawartością? Ta akcja jest nieodwracalna!',
			...
			'ALBUMS_NEW_TITLE' => 'Wpisz tytuł dla %0 wybranych albumów:',
			...
			'ALBUM_MERGE' => 'Czy na pewno połączyć ten album \'%0\' z albumem \'%1\'?',
			'ALBUMS_MERGE' => 'Czy na pewno połączyć zaznaczone albumy z \'%0\'?',
			'MERGE_ALBUM' => 'Połącz albumy',
			'DONT_MERGE' => 'Anuluj',
			'ALBUM_MOVE' => 'Czy na pewno przenieść album \'%0\' do albumu \'%1\'?',
			...
			'PHOTOS_NEW_TAGS' => 'Wpisz tagi dla %0 zaznaczonych zdjęć. Istniejące tagi zostaną nadpisane. Możesz wpisać więcej tagów rozdzielając je przecinkiem:',
			...
			'PHOTO_KEEP' => 'Anuluj',
			'PHOTO_DELETE_CONFIRMATION' => 'Czy na pewno usunąć zdjęcie \'%0\'? Akcja jest nieodwracalna!',
			'PHOTO_DELETE_ALL' => 'Czy na pewno usunąć %0 zaznaczone zdjęcia? Akcja jest nieodwracalna!',
			'PHOTOS_NEW_TITLE_' => 'Wpisz tytuł dla %0 zaznaczonych zdjęć:',
			...
			'SORT_ALBUM_BY' => 'Sortuj albumy według pola %0 w kolejności %1',
			...
			'SORT_PHOTO_BY' => 'Sortuj zdjęcia według pola %0 w kolejności %1',
			...
			'FOOTER_COPYRIGHT' => 'All images on this website are subject to Copyright by %0 &copy; %1',
