...
final class ChineseTraditional implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'KEEP_ALBUM' => '保留相簿',
			'DELETE_ALBUM_CONFIRMATION' => '確定要刪除相簿 \'%0\' 以及相簿內包含的所有照片？此動作無法還原！',

			'DELETE_ALBUMS_QUESTION' => '刪除相簿和照片',
			'KEEP_ALBUMS' => '保留相簿',
			'DELETE_ALBUMS_CONFIRMATION' => '確定要刪除全部照片 %0 選取的相簿和其中的所有照片？此動作無法還原！',
			...
			'ALBUMS_NEW_TITLE' => '設定標題為 %0 已選擇的所有相簿：',
			...
			'ALBUM_MERGE' => '你確定要合併相簿 \'%0\' 到該相簿 \'%1\'?',
			'ALBUMS_MERGE' => '你確定要合併所有已選擇的相簿到該相簿 \'%0\'?',
			'MERGE_ALBUM' => '合併相簿',
			'DONT_MERGE' => '不要合併',
			'ALBUM_MOVE' => '您確定要移動相簿 \'%0\' 到該相簿 \'%1\'?',
			...
			'PHOTOS_NEW_TAGS' => '大量標籤 %0 標籤已選照片(已存在的標籤會被覆蓋；用逗號分隔)：',
			'PHOTO_SET_TAGS' => '設定標籤',
			'PHOTO_CAMERA' => '相機資訊',
			'PHOTO_CAPTURED' => '拍攝時間',
			'PHOTO_MAKE' => '設備',
			...
			'PHOTO_DELETE' => '刪除照片',
			'PHOTO_KEEP' => '保留照片',
			'PHOTO_DELETE_CONFIRMATION' => '是否要刪除照片 \'%0\'? 此動作無法還原！',
			'PHOTO_DELETE_ALL' => '是否要刪除除所有 %0 已選擇的照片？此動作無法還原！',
			'PHOTOS_NEW_TITLE_' => '批量編輯照片標題 %0 已選的照片：',
			...
			'ABOUT_DESCRIPTION' => '<a target=\'_blank\' href=\'%0\'>Lychee</a> 是一個免費的照片管理工具，可在您的伺服器或網站空間上運行。安裝僅需幾秒鐘。<br>上傳，管理和分享照片(例如從本機應用程序)。<br>Lychee提供您所需的一切，所有照片均安全存儲。',
			'FOOTER_COPYRIGHT' => '本網站的照片均受版權所有 %0 &copy; %1',
