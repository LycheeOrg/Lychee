...
final class Portuguese implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'DELETE_ALBUM_CONFIRMATION' => 'De certeza que quer eliminar o álbum \'%0\' e todas as fotografias contidas? Esta ação não pode ser desfeita!',

			'DELETE_ALBUMS_QUESTION' => 'Eliminar Álbums e Fotos',
			'KEEP_ALBUMS' => 'Manter Álbums',
			'DELETE_ALBUMS_CONFIRMATION' => 'De certeza que quer eliminar todos %0 os álbums e todas as fotografias neles contidas? Esta ação não pode ser desfeita!',
			...
			'ALBUMS_NEW_TITLE' => 'Inserir um título para todos %0 álbums selecionados:',
			...
			'ALBUM_MERGE' => 'De certeza que quer fundir o álbum \'%0\' com o álbum \'%1\'?',
			'ALBUMS_MERGE' => 'De certeza que quer fundir todos os álbums selecionados com o álbum \'%0\'?',
			'MERGE_ALBUM' => 'Fundir Álbums',
			'DONT_MERGE' => 'Não Fundir',
			'ALBUM_MOVE' => 'De certeza que quer mover o álbum \'%0\' para o álbum \'%1\'?',
			...
			'PHOTOS_NEW_TAGS' => 'Inserir as suas etiquetas para todas %0 as fotografias selecionadas. Etiquetas existentes vão ser substituídas. Pode adicionar várias etiquetas separando-as com uma vírgula:',
			...
			'PHOTO_DELETE_CONFIRMATION' => 'De certeza que quer eliminar a fotografia \'%0\'? Esta ação não pode ser desfeita!',
			'PHOTO_DELETE_ALL' => 'De certeza que quer eliminar todas %0 as fotografias selecionadas? Esta ação não pode ser desfeita!',
			'PHOTOS_NEW_TITLE_' => 'Inserir um título para todas %0 as fotografias selecionadas:',
			...
			'SORT_ALBUM_BY' => 'Ordenar álbums por %0 numa %1 ordem.',
			...
			'SORT_PHOTO_BY' => 'Ordenar fotografias por %0 numa %1 ordem.',
