...
final class German implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'DELETE_ALBUM_CONFIRMATION' => 'Sind Sie sicher, dass Sie das Album „%0“ und alle enthaltenen Fotos löschen wollen? Diese Aktion kann nicht rückgängig gemacht werden!',

			'DELETE_ALBUMS_QUESTION' => 'Alben und Fotos löschen',
			'KEEP_ALBUMS' => 'Alben behalten',
			'DELETE_ALBUMS_CONFIRMATION' => 'Sind Sie sicher, dass Sie alle %0 ausgewählten Alben und die enthaltenen Fotos löschen wollen? Diese Aktion kann nicht rückgängig gemacht werden!',
			...
			'ALBUMS_NEW_TITLE' => 'Geben Sie einen Titel für alle %0 ausgewählten Alben ein:',
			...
			'ALBUM_MERGE' => 'Sind Sie sicher, dass Sie das Album „%0“ mit dem Album „%1“ zusammenführen wollen?',
			'ALBUMS_MERGE' => 'Sind Sie sicher, dass Sie alle ausgewählten Alben mit dem Album „%0“ zusammenführen möchten?',
			'MERGE_ALBUM' => 'Alben zusammenführen',
			'DONT_MERGE' => 'Nicht zusammenführen',
			'ALBUM_MOVE' => 'Sind Sie sicher, dass Sie das Album „%0“ nach „%1“ verschieben möchten?',
			...
			'PHOTOS_NEW_TAGS' => 'Geben Sie die Tags für alle %0 ausgewählten Fotos ein. Bestehende Tags werden überschrieben. Sie können mehrere Tags hinzufügen, indem Sie sie mit einem Komma trennen:',
			...
			'PHOTO_DELETE_CONFIRMATION' => 'Sind Sie sicher, dass Sie das Foto „%0“ löschen wollen? Diese Aktion kann nicht rückgängig gemacht werden!',
			'PHOTO_DELETE_ALL' => 'Sind Sie sicher, dass Sie alle %0 ausgewählten Fotos löschen wollen? Diese Aktion kann nicht rückgängig gemacht werden!',
			'PHOTOS_NEW_TITLE_' => 'Geben Sie einen Titel für die %0 ausgewählten Fotos ein:',
			...
			'SORT_ALBUM_BY' => 'Alben nach %0 in einer %1 Reihenfolge sortieren.',
			...
			'SORT_PHOTO_BY' => 'Fotos nach %0 in einer %1 Reihenfolge sortieren.',
			...
			'ABOUT_DESCRIPTION' => '<a target=\'_blank\' href=\'%0\'>Lychee</a> ist ein freies Foto-Management-Werkzeug, dass auf Ihrem Server oder Webspace läuft. Die Installation ist eine Sache von Sekunden. Hochladen, Organisieren und Teilen von Fotos funktioniert wie in einer nativen Anwendung. Lychee hält alles bereit, was Sie benötigen, und alle Bilder werden sicher abgespeichert.',
			'FOOTER_COPYRIGHT' => 'Alle Bilder auf dieser Website unterliegen dem Copyright von %0 &copy; %1',
			...
			'ERROR_PHOTO_NOT_FOUND' => 'Fehler: Foto %0 wurde nicht gefunden!',
