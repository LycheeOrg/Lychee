...
final class Czech implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'DELETE_ALBUM_CONFIRMATION' => 'Opravdu smazat album \'%0\' a všechny fotografie, které obsahuje? Tento krok je nevratný!',

			'DELETE_ALBUMS_QUESTION' => 'Mazání alb a fotografií',
			'KEEP_ALBUMS' => 'Ponechat alba',
			'DELETE_ALBUMS_CONFIRMATION' => 'Opravdu smazat všechna vybraná %0 alba a fotografie, které obsahují? Tento krok je nevratný!',
			...
			'ALBUMS_NEW_TITLE' => 'Zadat nový název pro %0 vybraná alba:',
			...
			'ALBUM_MERGE' => 'Sloučení vybraných alb \'%0\' do jednoho alba \'%1\'?',
			'ALBUMS_MERGE' => 'Sloučit \'%0\'?',
			'MERGE_ALBUM' => 'Sloučit alba',
			'DONT_MERGE' => 'Neslučovat',
			'ALBUM_MOVE' => 'Opravdu přesunout album \'%0\' do alba \'%1\'?',
			...
			'PHOTOS_NEW_TAGS' => 'Zadejte štítky pro všechny %0 vybrané fotografie. Stávající štítky budou přepsány. Jednotlivé štítky oddělte čárkou:',
			...
			'PHOTO_DELETE_CONFIRMATION' => 'Opravdu odstranit fotografii \'%0\'? Tento krok je nevratný!',
			'PHOTO_DELETE_ALL' => 'Opravdu odstranit všechny %0 vybrané fotografie? Tento krok je nevratný!',
			'PHOTOS_NEW_TITLE_' => 'Zadejte nový název pro všechny %0 vybrané fotografie:',
			...
			'SORT_ALBUM_BY' => 'Řadit alba podle %0 ve %1 pořadí.',
			...
			'SORT_PHOTO_BY' => 'Řadit alba podle %0 ve %1 pořadí.',
			...
			'ABOUT_DESCRIPTION' => '<a target=\'_blank\' href=\'%0\'>Lychee</a> je open-source nástroj na správu fotogragfií na Vašem serveru nebo webu. Instalace je hotova dílem okmažiku. Upload, správa a sdílení fotografií se provádí běžnými aplikacemi. Lychee přináší vše, co je třeba pro bezpečné online uložení Vašich fotografií.',
			'FOOTER_COPYRIGHT' => 'Všechny fotografie na tomto webu jsou ve vlastnictví Copyright %0 &copy; %1',
