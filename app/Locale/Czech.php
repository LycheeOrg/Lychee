...
final class Czech implements LangInterface
{
	...
	public static function get_locale()
	{
		$locale = array(
			...
			'SAVE_RISK' => 'Uložit změny, rizika jsou mi známá!',
			...
			'FULLSCREEN_ENTER' => 'Spustit fullscreen',
			'FULLSCREEN_EXIT' => 'Ukončit fullscreen',
			...
			'ALBUM_PASSWORD_REQUIRED' => 'Toto album je chráněno heslem. K jeho zobrazení zadejte prosím platn0 heslo:',
			...
			'PHOTO_NEW_TAGS_2' => 'vybraé fotografie. Stávající štítky budou přepsány. Jednotlivé štítky oddělte čárkou:',
			...
			'PHOTOS_NEW_TITLE_1' => 'Zadejtenový název pro všechny',
			...
			'PHOTO_NO_EDIT_SHARING_TEXT' => 'Protože je tato fotografie umístěna ve veřejném albu, zdědí i nastavení tohoto veřejného alba. Aktuální viditelnost je uvedena pouze pro informaci.',
			'PHOTO_EDIT_GLOBAL_SHARING_TEXT' => 'Viditelnost této fotografie lze doladit pomocí globálních nastavení. Aktuální viditelnost je uvedena pouze pro informaci.',
			...
			'SETTINGS_WARNING' => 'Změna rozšířených nastavení může mít negativní vlyv na stabilitu, bezpečnost a rychlost Lychee. Měňte pouze to, co opravdu dobře chápete.',
			...
			'VIEW_NO_PUBLIC_ALBUMS' => 'Žádné veřejné albym',
			...
			'UPLOAD_IMPORT_WARN_ERR' => 'Import byl dokončen s upozorněními nebo chybami. Podrobnosti si prosím prohlédněte v protokolu (Nastaveni -> Protokoly).',
			...
			'UPLOAD_IMPORT_SERVER_FOLD' => 'Složka je prázdná nebo neobsahuje soubory, které lze zpracovat. Podrobnosti si prosím prohlédněte v protokolu (Nastaveni -> Protokoly).',
			...
			'ABOUT_SUBTITLE' => 'Správé řešené vlastního hostování a správy fotografií',
			'ABOUT_DESCRIPTION' => 'je open-source nástroj na správu fotogragfií na Vašem serveru nebo webu. Instalace je dílem okmažiku. Upload, správa a sdílení fotografií běžnými aplikacemi. Lychee přináší vše, co je třeba pro bezpečné uložení Vašich fotografií.',
