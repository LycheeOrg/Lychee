...
final class French implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'DELETE_ALBUM_CONFIRMATION' => 'Voulez-vous vraiment supprimer l’album \'%0\' et toutes les photos qu’il contient ? Cette action est irréversible !',

			'DELETE_ALBUMS_QUESTION' => 'Supprimer les albums et leurs photos',
			'KEEP_ALBUMS' => 'Garder les albums',
			'DELETE_ALBUMS_CONFIRMATION' => 'Voulez-vous vraiment supprimer les %0 albums selectionnés et toutes leurs photos ? Cette action est irréversible !',
			...
			'ALBUMS_NEW_TITLE' => 'Entrez un titre pour les %0 albums sélectionnés :',
			...
			'ALBUM_MERGE' => 'Voulez-vous vraiment fusionner l’album \'%0\' dans l’album \'%1\'?', // `dans` est important car il indique la direction du merge
			'ALBUMS_MERGE' => 'Voulez-vous vraiment fusionner les albums selectionnés avec l’album \'%0\'?',
			'MERGE_ALBUM' => 'Fusionner les albums',
			'DONT_MERGE' => 'Ne pas fusionner.',
			'ALBUM_MOVE' => 'Voulez-vous vraiment déplacer l’album \'%0\' dans l’album \'%1\'?',
			...
			'PHOTOS_NEW_TAGS' => 'Entrez vos étiquettes pour toutes les %0 photos selectionnées. Les tags existants seront remplacés. Vous pouvez ajouter plusieurs tags en les séparant avec une virgule :',
			...
			'PHOTO_DELETE_CONFIRMATION' => 'Voulez-vous vraiment supprimer la photo ? \'%0\'Cette action est irréversible !',
			'PHOTO_DELETE_ALL' => 'Voulez-vous vraiment supprimer toutes les %0 photos sélectionnées ? Cette action est irréversible !',
			'PHOTOS_NEW_TITLE_' => 'Entrer un titre pour toutes les %0 photos sélectionnées :',
			...
			'SORT_ALBUM_BY' => 'Trier les albums %0 dans l’ordre %1.',
			...
			'SORT_PHOTO_BY' => 'Trier les photos %0 dans l’ordre %1.',
			...
			'ABOUT_DESCRIPTION' => '<a target=\'_blank\' href=\'%0\'>Lychee</a> est une outil de gestion de gallerie gratuit qui fonctionne sur votre propre serveur. L’installation est rapide. Uploadez, gérez et partagez vos photos comme avec une application propre. Lychee vous fourni tout ce dont vous avez besoin et vos photos sont stockées en sécurité chez vous.',
			'FOOTER_COPYRIGHT' => 'Toutes les images de ce site Web sont protégées par le droit d’auteur par %0 &copy; %1',
