...
final class French implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'ALBUM_SHR_NO' => 'Non',
			'ALBUM_PUBLIC' => 'Public',
			'ALBUM_PUBLIC_EXPL' => 'Des utilisateurs anonymes peuvent accéder à cet album, sous réserve des restrictions suivantes.',
			'ALBUM_FULL' => 'Originaux',
			'ALBUM_FULL_EXPL' => 'Les images sont disponibles en complète résolution.',
			'ALBUM_HIDDEN' => 'Masqué',
			'ALBUM_HIDDEN_EXPL' => 'Des utilisateurs anonymes ont besoin d’un lien direct pour accéder à cet album.',
			...
			'ALBUM_DOWNLOADABLE_EXPL' => 'Des utilisateurs anonymes peuvent télécharger cet album.',
			...
			'ALBUM_PASSWORD_PROT_EXPL' => 'Des utilisateurs anonymes ont besoin d’un mot de passe partagé pour accéder à cet album.',
			...
			'PHOTO_PUBLIC' => 'Public',
			'PHOTO_PUBLIC_EXPL' => 'Des utilisateurs anonymes peuvent visualiser cette photo, sous réserve des restrictions suivantes.',
