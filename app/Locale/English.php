...
final class English implements LangInterface
{
	...
	public static function get_locale()
	{
		$locale = array(
			...
			'PHOTO_PUBLIC' => 'Public',
			'PHOTO_PUBLIC_EXPL' => 'Photo can be viewed by everybody.',
			'PHOTO_FULL' => 'Full size',
			'PHOTO_FULL_EXPL' => 'Full size picture is available.',
			'PHOTO_HIDDEN' => 'Hidden',
			'PHOTO_HIDDEN_EXPL' => 'Only people with the direct link can view this photo.',
			'PHOTO_DOWNLOADABLE' => 'Downloadable',
			'PHOTO_DOWNLOADABLE_EXPL' => 'Visitors of your Lychee can download this photo.',
