...
final class English implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'DELETE_ALBUM_CONFIRMATION' => 'Are you sure you want to delete the album \'%0\' and all of the photos it contains? This action can\'t be undone!',
			...
			'ALBUMS_MERGE' => 'Are you sure you want to merge all selected albums into the album \'%0\'?',
