...
final class Dutch implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'DELETE_ALBUM_CONFIRMATION' => 'Weet je zeker dat je dit album en alle foto\'s die het \'%0\' bevat wilt verwijderen? Deze actie kan niet ongedaan gemaakt worden!',

			'DELETE_ALBUMS_QUESTION' => 'Verwijder Albums en Foto\'s',
			'KEEP_ALBUMS' => 'Behoud Albums',
			'DELETE_ALBUMS_CONFIRMATION' => 'Weet je zeker dat je deze albums en alle foto\'s die ze %0 bevatten wilt verwijderen? Deze actie kan niet ongedaan gemaakt worden!',
			...
			'ALBUMS_NEW_TITLE' => 'Geef alle geselecteerde %0 albums een nieuwe titel:',
			...
			'ALBUM_MERGE' => 'Weet je zeker dat je dit album wilt samenvoegen \'%0\' met het album \'%1\'?',
			'ALBUMS_MERGE' => 'Weet je zeker dat je alle albums wilt samenvoegen naar \'%0\'?',
			...
			'PHOTOS_NEW_TAGS' => 'Voer je tags in voor alle %0 geselecteerde foto\'s, meerdere tags kunnen worden gescheiden door komma\'s:',
			...
			'PHOTO_DELETE_CONFIRMATION' => 'Weet je zeker dat je deze foto\'s wilt verwijderen? \'%0\' Deze actie kan niet ongedaan gemaakt worden!',
			'PHOTO_DELETE_ALL' => 'Weet je zeker dat je alle geslecteerd foto\'s wilt verwijderen? %0 Deze actie kan niet ongedaan gemaakt worden!',
			'PHOTOS_NEW_TITLE_' => 'Voer een titel in voor alle %0 geselecteerde foto\'s:',
			...
			'SORT_ALBUM_BY' => 'Sorteer albums op %0 in een %1 volgorde.',
			...
			'SORT_PHOTO_BY' => 'Sorteer albums op %0 in een %1 volgorde.',
			...
			'FOOTER_COPYRIGHT' => 'Alle afbeeldingen op deze website zijn onderworpen aan het auteursrecht van %0 &copy; %1',
