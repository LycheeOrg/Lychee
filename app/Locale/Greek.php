...
final class Greek implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'DELETE_ALBUM_CONFIRMATION' => 'Είστε σίγουρη/ος πως θέλετε να διαγράψετε αυτό το λεύκωμα \'%0\' και όλες τις φωτογραφίες που περιέχει; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί!',

			'DELETE_ALBUMS_QUESTION' => 'Διαγραφή Λευκωμάτων και Φωτογραφιών',
			'KEEP_ALBUMS' => 'Διατήρηση Λευκωμάτων',
			'DELETE_ALBUMS_CONFIRMATION' => 'Είστε σίγουρη/ος πως θέλετε να διαγράψετε όλα %0 τα επιλεγμένα λευκώματα και όλες τις φωτογραφίες που περιέχουν; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί!',
			...
			'ALBUMS_NEW_TITLE' => 'Εισάγετε νέο τίτλο για όλα %0 τα επιλεγμένα λευκώματα:',
			...
			'ALBUM_MERGE' => 'Είστε σίγουρη/ος πως θέλετε να συγχωνεύσετε αυτό το λεύκωμα \'%0\' σε αυτό το λεύκωμα \'%1\'?',
			'ALBUMS_MERGE' => 'Είστε σίγουρη/ος πως θέλετε να συγχωνεύσετε όλα τα επιλεγμένα λευκώματα \'%0\'?',
			'MERGE_ALBUM' => 'Συγχώνευση Λευκωμάτων',
			'DONT_MERGE' => 'Να μη γίνει συγχώνευση',
			'ALBUM_MOVE' => 'Είστε σίγουρη/ος πως θέλετε να μετακινήσετε το λεύκωμα \'%0\' σε αυτό το λεύκωμα \'%1\'?',
			...
			'PHOTOS_NEW_TAGS' => 'Εισάγετε τις ετικέτες σας για όλες %0 τις επιλεγμένες φωγογραφίες. Υφιστάμενες ετικέτες θα αντικατασταθούν. Μπορείτε να προσθέσετε πολλαπλές ετικέτες χωρίζοντάς \'τες με ένα κόμμα:',
			...
			'PHOTO_DELETE_CONFIRMATION' => 'Είστε σίγουρη/ος πως θέλετε να διαγράψετε αυτή τη φωτογραφία \'%0\'; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί!',
			'PHOTO_DELETE_ALL' => 'Είστε σίγουρη/ος πως θέλετε να διαγράψετε όλες %0 τις επιλεγμένες φωτογραφίες; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί!',
			'PHOTOS_NEW_TITLE_' => 'Εισάγετε νέο τίτλο για όλες %0 τις επιλεγμένες φωτογραφίες:',
			...
			'SORT_ALBUM_BY' => 'Ταξινόμηση λευκωμάτων κατά %0 με %1 σειρά.',
			...
			'SORT_PHOTO_BY' => 'Ταξινόμηση Φωτογραφιών κατά',
			'SORT_PHOTO_BY_2' => 'με',
