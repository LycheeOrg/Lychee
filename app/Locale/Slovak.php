...
final class Slovak implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'DELETE_ALBUM_CONFIRMATION' => 'Ste si istý, že chcete album \'%0\' a všetky obrázky v ňom zmazať? Táto akcia je nevratná!',

			'DELETE_ALBUMS_QUESTION' => 'Všetky albumy a obrázky zmazať',
			'KEEP_ALBUMS' => 'Albumy ponechať',
			'DELETE_ALBUMS_CONFIRMATION' => 'Ste si istý, že chcete všetky %0 vybrané albumy a všetky obrázky v nich zmazať? Táto akcia je nevratná!',
			...
			'ALBUMS_NEW_TITLE' => 'Zadajte názov pre všetky %0 vybrané albumy:',
			...
			'ALBUM_MERGE' => 'Ste si istý, že chcete album \'%0\' s týmto albumom zlúčiť \'%1\'?',
			'ALBUMS_MERGE' => 'Ste si istý, že chcete všetky vybrané albumy s týmto albumom zlúčiť \'%0\'?',
			'MERGE_ALBUM' => 'Albumy zlúčiť',
			'DONT_MERGE' => 'Nezlučovať',
			'ALBUM_MOVE' => 'Ste si istý, že chcete album \'%0\' presunúť do nasledujúceho albumu \'%1\'?',
			...
			'PHOTOS_NEW_TAGS' => 'Zadajte štítky pre všetky %0 vybrané obrázky. Doterajšie štítky budú prepísané.Jednotlivé štítky oddeľte čiarkou:',
			...
			'PHOTO_DELETE_CONFIRMATION' => 'Ste si istý, že chcete obrázok \'%0\'zmazať?  Táto akcia je nevratná!',
			'PHOTO_DELETE_ALL' => 'Ste si istý, že chcete všetky %0 vybrané obrázky zmazať?  Táto akcia je nevratná!',
			'PHOTOS_NEW_TITLE_' => 'Zadaje nový názov pre všetky %0 vybrané obrázky:',
			...
			'SORT_ALBUM_BY' => 'Triediť albumy podľa %0 v %1 rade.',
			...
			'SORT_PHOTO_BY' => 'Obrázky triediť podľa %0 v %1 rade.',
			...
			'ABOUT_DESCRIPTION' => '<a target=\'_blank\' href=\'%0\'>Lychee</a> je open-source nástroj, bežiaci na vašom vlastnom serveri alebo v cloude. Inštalácia je otázkou sekúnd. Nahrať, spravovať a zdieľať obrázky ako v natívnej aplikácii. Lychee ponúka všetko čo potrebujete vy a vaše obrázky pre bezpečné uloženie.',
			'FOOTER_COPYRIGHT' => 'Všetky obrázky na tejto webovej stránke sú chránené autorským právom %0 &copy; %1',
