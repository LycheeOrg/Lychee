...
final class Vietnamese implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'USERS' => 'Người dùng',
			'ALLOW_UPLOAD' => 'Cho phép đăng hình ảnh video',
			'RESTRICTED_ACCOUT' => 'Không được chỉnh cài đặt',
			'CREATE' => 'Tạo',
			...
			'DELETE_ALBUMS_CONFIRMATION_2' => 'các album được chọn và cả những hình ảnh chứa trong đó? Thao tác này sẽ không được phục hồi lại!',
			...
			'ALBUMS_NEW_TITLE_1' => 'Đặt tên cho tất cả',
			'ALBUMS_NEW_TITLE_2' => 'những album được chọn:',
			...
			'ALBUM_MERGE_1' => 'Bạn có chắc chắn là muốn gộp chung album',
			'ALBUM_MERGE_2' => 'vào album',
			'ALBUMS_MERGE' => 'Bạn có chắc là muốn gộp hết tất cả những album được chọn vào trong cùng album',
			'MERGE_ALBUM' => 'Gộp những album lại với nhau',
			'DONT_MERGE' => 'Không gộp',
			'ALBUM_MOVE_1' => 'Bạn có chắc là muốn di chuyển album',
			'ALBUM_MOVE_2' => 'qua album',
			'ALBUMS_MOVE' => 'Bạn có chắc là muốn di chuyển tất cả những album được chọn vào trong album',
			...
			'PHOTO_NEW_TAGS_1' => 'Nhập thẻ tag của bạn cho tất cả',
			'PHOTO_NEW_TAGS_2' => 'những hình ảnh được chọn. Những thẻ tag đang có sẽ được cập nhật. Bạn có thể thêm vào nhiều tag cách ra bởi dấu phẩy:',
			...
			'PHOTO_FOCAL' => 'Tiêu cự',
			'PHOTO_ISO' => 'Độ nhạy sáng',
			'PHOTO_SHARING' => 'Chia sẻ',
			'PHOTO_SHR_PLUBLIC' => 'Chia sẻ công cộng',
			...
			'PHOTO_DELETE_1' => 'Bạn có chắc là bạn muốn xóa hình ảnh này',
			'PHOTO_DELETE_2' => '? Thao tác này sẽ không được khôi phục lại!',
			'PHOTO_DELETE_ALL_1' => 'Bạn có chắc là bạn muốn xóa tất cả',
			'PHOTO_DELETE_ALL_2' => 'hình ảnh được chọn? Thao tác này sẽ không khôi phục lại được!',
			'PHOTOS_NEW_TITLE_1' => 'Nhập tên cho tất cả',
			'PHOTOS_NEW_TITLE_2' => 'những hình ảnh được chọn:',
			...
			'SORT_ALBUM_BY_1' => 'Sắp xếp album theo',
			'SORT_ALBUM_BY_2' => 'một',
			'SORT_ALBUM_BY_3' => 'thứ tự.',
			...
			'SORT_PHOTO_BY_1' => 'Sắp xếp hình ảnh theo',
			'SORT_PHOTO_BY_2' => 'một',
			'SORT_PHOTO_BY_3' => 'thứ tự.',
