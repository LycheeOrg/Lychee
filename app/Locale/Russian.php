...
final class Russian implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'DELETE_ALBUM_CONFIRMATION' => 'Вы точно хотите удалить альбом \'%0\' со всеми фотографиями? Это действие необратимо!',

			'DELETE_ALBUMS_QUESTION' => 'Удалить альбом и фотографии',
			'KEEP_ALBUMS' => 'Сохранить альбомы',
			'DELETE_ALBUMS_CONFIRMATION' => 'Вы точно хотите удалить альбомы %0 со всеми фотографиями? Это действие необратимо!',
			...
			'ALBUMS_NEW_TITLE' => 'Введите заголовок для всех %0 выбранных альбомов:',
			...
			'ALBUM_MERGE' => 'Вы точно хотите объединить альбом \'%0\' с альбомом \'%1\'?',
			'ALBUMS_MERGE' => 'Вы точно хотите объединить все выбранные альбомы в альбом \'%0\'?',
			'MERGE_ALBUM' => 'Объединить альбомы',
			'DONT_MERGE' => 'Не объединять',
			'ALBUM_MOVE' => 'Вы точно хотите переместить альбом \'%0\' в альбом \'%1\'?',
			...
			'PHOTOS_NEW_TAGS' => 'Введите теги для всех %0 выбранных фотографий. Имеющиеся теги будут перезаписаны. Вы можете добавить несколько тегов, разделяя их запятыми:',
			...
			'PHOTO_DELETE_CONFIRMATION' => 'Вы точно хотите удалить фото \'%0\'? Это действие необратимо!',
			'PHOTO_DELETE_ALL' => 'Вы точно хотите удалить все %0 выбранные фото? Это действие необратимо!',
			'PHOTOS_NEW_TITLE_' => 'Введите заголовок для всех %0 выбранных фото:',
			...
			'SORT_ALBUM_BY' => 'Сортировать альбомы %0 в порядке %1.',
			...
			'SORT_PHOTO_BY' => 'Сортировать фотографии %0 в порядке %1.',
