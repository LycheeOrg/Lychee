...
final class Russian implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'SHARING' => 'Поделиться',
			'SHARING_EMPTY' => 'Список общего доступа пуст!',
			'SHARING_WITH' => 'with',
			'SHARING_SHARE' => 'Share',
			'SHARING_UNDO' => 'undo',
			'SHARING_REDO' => 'redo',
			...
			'DIAGNOSTICS_GET_SIZE' => 'Запросить использование пространства',
			'LOGS' => 'Логи',
			'CLEAN_LOGS' => 'Удалить лишнее',
			'CLEAR' => 'Очистить',
			'SIGN_OUT' => 'Выход',
			...
			'UPDATE' => 'Изменить',
			'RESET' => 'Сброс',
			'DISABLE_TOKEN_TOOLTIP' => 'Отключить',
			'ENABLE_TOKEN' => 'Включить API token',
			'DISABLED_TOKEN_STATUS_MSG' => 'Отключен',
			'TOKEN_BUTTON' => 'API Token ...',
			'TOKEN_NOT_AVAILABLE' => 'You have already viewed this token.',
			'TOKEN_WAIT' => 'Подождите ...',
			...
			'VISIBILITY_ALBUM' => 'Видимость альбома',
			'VISIBILITY_PHOTO' => 'Видимость фото',
			'DOWNLOAD_ALBUM' => 'Скачать альбом',
			'ABOUT_ALBUM' => 'Об альбоме',
			'DELETE_ALBUM' => 'Удалить альбом',
			'MOVE_ALBUM' => 'Переместить альбом',
			'FULLSCREEN_ENTER' => 'Полный экран',
			'FULLSCREEN_EXIT' => 'Оконный режим',

			'SHARING_ALBUM_USERS' => 'Поделитесь этим альбомом с пользователями',
			'WAIT_FETCH_DATA' => 'Пожалуйста, подождите, пока мы получим данные...',
			'SHARING_ALBUM_USERS_NO_USERS' => 'Нет пользователей, с которыми можно поделиться альбомом',
			'SHARING_ALBUM_USERS_LONG_MESSAGE' => 'Выберите пользователей, с которыми вы хотите поделиться этим альбомом',
			...
			'DELETE_TAG_ALBUM_QUESTION' => 'Удалить альбом',
			'DELETE_TAG_ALBUM_CONFIRMATION' => 'Вы точно хотите удалить альбом \'%s\' (фотографии не будут удалены)? Это действие необратимо!',
			...
			'REMOVE_COVER' => 'Удалить обложку альбома',
			...
			'ALBUM_NEW_SHOWTAGS' => 'Введите теги фотографий, которые будут видны в этом альбоме:',
			'ALBUM_SET_SHOWTAGS' => 'Установите теги для отображения',
			'ALBUM_ALBUM' => 'Альбом',
			...
			'ALBUM_SHR_NO' => 'Нет',
			'ALBUM_PUBLIC' => 'Доступ',
			'ALBUM_PUBLIC_EXPL' => 'Альбом могут просматривать другие пользователи с учетом приведенных ниже ограничений.',
			'ALBUM_FULL' => 'Оригинал',
			'ALBUM_FULL_EXPL' => 'Доступны изображения в полном разрешении.',
			...
			'ALBUM_NSFW_EXPL' => 'Альбом помечен как содержащий конфиденциальный контент.',
			...
			'ALBUM_SET_ORDER' => 'Задать сортировку',
			'ALBUM_ORDERING' => 'Сортировать по',
			'ALBUM_OWNER' => 'Владелец',
			...
			'PHOTO_LICENSE_HELP' => 'Нужна помощь в выборе?',
			'PHOTO_REUSE' => 'Авторские права',
			'PHOTO_LICENSE_NONE' => 'Нет',
			'PHOTO_RESERVED' => 'Все права защищены',
			'PHOTO_LATITUDE' => 'Широта',
			'PHOTO_LONGITUDE' => 'Долгота',
			'PHOTO_ALTITUDE' => 'Высота',
			'PHOTO_IMGDIRECTION' => 'Направление',
			'PHOTO_LOCATION' => 'Местоположение',
			'PHOTO_IMAGE' => 'Изображение',
			'PHOTO_VIDEO' => 'Видео',
			'PHOTO_SIZE' => 'Размер',
			'PHOTO_FORMAT' => 'Формат',
			'PHOTO_RESOLUTION' => 'Разрешение',
			'PHOTO_DURATION' => 'Продолжительность',
			'PHOTO_FPS' => 'Частота смены кадров',
			'PHOTO_TAGS' => 'Теги',
			...
			'PHOTO_PUBLIC' => 'Публичное',
			'PHOTO_PUBLIC_EXPL' => 'Фотографию могут просматривать другие пользователи с учетом приведенных ниже ограничений.',
			'PHOTO_FULL' => 'Оригинал',
			'PHOTO_FULL_EXPL' => 'Доступно изображение в полном разрешении.',
			'PHOTO_HIDDEN' => 'Скрыто',
			'PHOTO_HIDDEN_EXPL' => 'Только люди, у которых есть прямая ссылка, могут просмотреть эту фотографию.',
			'PHOTO_DOWNLOADABLE' => 'Скачиваемое',
			'PHOTO_DOWNLOADABLE_EXPL' => 'Посетители вашей галереи могут скачать эту фотографию.',
			'PHOTO_SHARE_BUTTON_VISIBLE' => 'Share button is visible',
			'PHOTO_SHARE_BUTTON_VISIBLE_EXPL' => 'Отображать ссылки для обмена в социальных сетях.',
			'PHOTO_PASSWORD_PROT' => 'Защищено паролем',
			'PHOTO_PASSWORD_PROT_EXPL' => 'Фотография доступна только с действительным паролем.',
			'PHOTO_EDIT_SHARING_TEXT' => 'Свойства общего доступа к этой фотографии будут изменены на следующие:',
			'PHOTO_NO_EDIT_SHARING_TEXT' => 'Поскольку эта фотография находится в общедоступном альбоме, она наследует настройки видимости этого альбома. Его текущая видимость показана ниже исключительно в информационных целях.',
			'PHOTO_EDIT_GLOBAL_SHARING_TEXT' => 'Видимость этой фотографии можно настроить с помощью глобальных настроек Lychee. Его текущая видимость показана ниже исключительно в информационных целях.',
			...
			'ERROR_MAP_DEACTIVATED' => 'Функциональность карты была отключена в настройках.',
			'ERROR_SEARCH_DEACTIVATED' => 'Функция поиска была отключена в настройках.',
			'SUCCESS' => 'Ок',
			'RETRY' => 'Повторить',
			...
			'SETTINGS_SUCCESS_PUBLIC_SEARCH' => 'Публичный поиск обновлен',
			'SETTINGS_SUCCESS_LICENSE' => 'Лицензия по умолчанию установлена',
			'SETTINGS_SUCCESS_MAP_DISPLAY' => 'Обновлены настройки отображения карты',
			'SETTINGS_SUCCESS_MAP_DISPLAY_PUBLIC' => 'Обновлены настройки отображения карты для общедоступных альбомов',
			'SETTINGS_SUCCESS_MAP_PROVIDER' => 'Обновлены настройки поставщика карт',
			'SETTINGS_DROPBOX_KEY' => 'Dropbox API Key',

			'U2F_NOT_SUPPORTED' => 'U2F не поддерживается. Извините.',
			'U2F_NOT_SECURE' => 'Окружение не безопасно. U2F не доступен.',
			'U2F_REGISTER_KEY' => 'Зарегистрируйте новое устройство.',
			'U2F_REGISTRATION_SUCCESS' => 'Регистрация прошла успешно!',
			'U2F_AUTHENTIFICATION_SUCCESS' => 'Аутентификация прошла успешно!',
			'U2F_CREDENTIALS' => 'Учетные данные',
			'U2F_CREDENTIALS_DELETED' => 'Учетные данные удалены!',
			'U2F_NO_CREDENTIALS' => 'Список пуст!',

			'NEW_PHOTOS_NOTIFICATION' => 'Отправлять уведомления о новых фотографиях по электронной почте.',
			'SETTINGS_SUCCESS_NEW_PHOTOS_NOTIFICATION' => 'Обновлено уведомление о новых фотографиях',
			'USER_EMAIL_INSTRUCTION' => 'Добавьте адрес своей электронной почты ниже, чтобы включить получение уведомлений.<br />Чтобы прекратить получать электронные письма, просто удалите свой адрес.',
