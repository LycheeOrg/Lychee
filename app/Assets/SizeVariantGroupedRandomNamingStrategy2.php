 ...
 * type into top-level directories and uses a random end section.
 *
 * The top-level directories are followed by two-levels of subdirectories.
 * Size variants which belong to the same photo share the same random
 * end section.
 */
class SizeVariantGroupedRandomNamingStrategy2 extends SizeVariantBaseNamingStrategy
{
	/**
