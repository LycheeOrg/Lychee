...
/**
 * Specialized query builder for {@link \App\Models\UnTaggedAlbum}.
 *
 ...
 *
 * @template TModelClass of UnTaggedAlbum
 *
 * @extends FixedQueryBuilder<TModelClass>
 */
class UnTaggedAlbumBuilder extends FixedQueryBuilder
{
	/**
