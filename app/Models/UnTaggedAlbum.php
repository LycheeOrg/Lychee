...
use App\Models\Builders\UnTaggedAlbumBuilder;
use App\Models\Extensions\BaseAlbum;
use App\Models\Extensions\Thumb;
use App\Models\Extensions\ToArrayThrowsNotImplemented;
use App\Relations\HasManyUnTaggedPhotos;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Illuminate\Database\Query\Builder as BaseBuilder;

/**
 * App\Models\UnTaggedAlbum.
 *
 * @property Collection<int,Tag> $tags
 * @property bool                $is_and
 *
 * @method static UnTaggedAlbumBuilder|UnTaggedAlbum query()                       Begin querying the model.
 * @method static UnTaggedAlbumBuilder|UnTaggedAlbum with(array|string $relations) Begin querying the model with eager loading.
 *
 * @property string                            $id
 ...
 * @property Collection<int, User>             $shared_with
 *
 * @method static UnTaggedAlbumBuilder|UnTaggedAlbum addSelect($column)
 * @method static UnTaggedAlbumBuilder|UnTaggedAlbum join(string $table, string $first, string $operator = null, string $second = null, string $type = 'inner', string $where = false)
 * @method static UnTaggedAlbumBuilder|UnTaggedAlbum joinSub($query, $as, $first, $operator = null, $second = null, $type = 'inner', $where = false)
 * @method static UnTaggedAlbumBuilder|UnTaggedAlbum leftJoin(string $table, string $first, string $operator = null, string $second = null)
 * @method static UnTaggedAlbumBuilder|UnTaggedAlbum newModelQuery()
 * @method static UnTaggedAlbumBuilder|UnTaggedAlbum newQuery()
 * @method static UnTaggedAlbumBuilder|UnTaggedAlbum orderBy($column, $direction = 'asc')
 * @method static UnTaggedAlbumBuilder|UnTaggedAlbum select($columns = [])
 * @method static UnTaggedAlbumBuilder|UnTaggedAlbum whereId($value)
 * @method static UnTaggedAlbumBuilder|UnTaggedAlbum whereIn(string $column, string $values, string $boolean = 'and', string $not = false)
 * @method static UnTaggedAlbumBuilder|UnTaggedAlbum whereNotIn(string $column, string $values, string $boolean = 'and')
 * @method static UnTaggedAlbumBuilder|UnTaggedAlbum whereShowTags($value)
 *
 * @mixin \Eloquent
 */
class UnTaggedAlbum extends BaseAlbum
{
	 ...
	 */
	public function photos(): HasManyUnTaggedPhotos
	{
		return new HasManyUnTaggedPhotos($this);
	}

	/**
	 * Returns the value for the virtual attribute {@link UnTaggedAlbum::$thumb}.
	 *
	 ...
	 *
	 * @return UnTaggedAlbumBuilder
	 */
	public function newEloquentBuilder($query): UnTaggedAlbumBuilder
	{
		return new UnTaggedAlbumBuilder($query);
	}
}
