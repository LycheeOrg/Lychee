...
class Download extends Component
{
	...
	public function __construct(Photo $photo)
	{
		...
		$this->size_variants = collect([
			'original' => $original === null ? null : SizeVariantResource::make($original)->noUrl($downgrade)->toArray(null),
			'medium2x' => $medium2x === null ? null : SizeVariantResource::make($medium2x)->toArray(null),
			'medium' => $medium === null ? null : SizeVariantResource::make($medium)->toArray(null),
			'small2x' => $small2x === null ? null : SizeVariantResource::make($small2x)->toArray(null),
			'small' => $small === null ? null : SizeVariantResource::make($small)->toArray(null),
			'thumb2x' => $thumb2x === null ? null : SizeVariantResource::make($thumb2x)->toArray(null),
			'thumb' => $thumb === null ? null : SizeVariantResource::make($thumb)->toArray(null),
		])
		->filter(fn ($e) => $e !== null)
		->map(function ($v, $k) {
