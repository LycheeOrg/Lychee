...
class NsfwDetectionResultsRequest extends BaseApiRequest
{
	...
	public function rules(): array
	{
		return [
			...
			'all_detected.*.label' => ['required_with:all_detected', new Enum(NsfwDetectionLabel::class)],
			...
			'block_detected.*.label' => ['required_with:block_detected', 'string', new Enum(NsfwDetectionLabel::class)],
			...
			'review_detected.*.label' => ['required_with:review_detected', 'string', new Enum(NsfwDetectionLabel::class)],
			...
			'sensitive_detected.*.label' => ['required_with:sensitive_detected', 'string', new Enum(NsfwDetectionLabel::class)],
