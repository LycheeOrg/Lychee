 ...
 * DO-061-07). Validates `album_id` identically to
 * {@see \App\Http\Requests\Album\GetAlbumBucketsRequest} (DO-061-01): route
 * segment, `required`, `RandomIDRule`, resolves to a regular {@see Album}
 * only.
 */
class GetAlbumChildrenDataRequest extends BaseApiRequest
{
	private Album $album;
