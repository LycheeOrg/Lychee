...
/**
 * Request for `GET /api/v3/Map/Photos` (FR-067-02, FR-067-09). Mirrors
 * {@see GetMapBucketsRequest} exactly — see its own doc comment for the
 * `include_sub_albums` omission rationale (Q-067-08).
 */
class GetMapPhotosRequest extends BaseApiRequest implements HasAbstractAlbum
{
