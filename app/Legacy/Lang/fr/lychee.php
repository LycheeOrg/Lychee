...
return [
	...
	'SET_DROPBOX' => 'Configurer Dropbox',
	...
	'RESET' => 'Réinitialiser',
	'DISABLE_TOKEN_TOOLTIP' => 'Désactiver',
	...
	'KEEP_UNSORTED' => 'Conserver Non-triés',
	...
	'SET_HEADER' => 'Définir comme image d’en-tête',
	'REMOVE_HEADER' => 'Supprimer l\image d’en-tête',
	'SET_COMPACT_HEADER' => 'Utiliser l’entête compacte',
	...
	'ALBUM_NEW_TITLE' => 'Saisissez un nouveau titre pour cet album :',
	'ALBUMS_NEW_TITLE' => 'Saisissez un titre pour les %d albums sélectionnés :',
	'ALBUM_SET_TITLE' => 'Enregistrer le titre',
	'ALBUM_DESCRIPTION' => 'Description',
	'ALBUM_SHOW_TAGS' => 'Étiquettes à afficher',
	'ALBUM_NEW_DESCRIPTION' => 'Saisissez une nouvelle description pour cet album :',
	'ALBUM_SET_DESCRIPTION' => 'Choisir une description',
	'ALBUM_NEW_SHOWTAGS' => 'Saisissez les étiquettes des photos qui seront affichées dans cet album :',
	...
	'PHOTO_NEW_DESCRIPTION' => 'Saisissez une nouvelle description pour cette photo :',
	...
	'PHOTO_NEW_TAGS' => 'Saisissez vos étiquettes pour cette photo. Vous pouvez ajouter plusieurs étiquettes en les séparant avec une virgule :',
	'PHOTOS_NEW_TAGS' => 'Saisissez vos étiquettes pour toutes les %d photos selectionnées. Les tags existants seront remplacés. Vous pouvez ajouter plusieurs tags en les séparant avec une virgule :',
	...
	'ERROR' => 'Erreur',
	'ERROR_TEXT' => 'Une erreur est survenue. Veuillez rafraichir la page et réessayer !',
	'ERROR_UNKNOWN' => 'Une erreur inattendue est survenue. Veuillez réessayer et vérifier votre installation et votre serveur. Consultez le fichier Readme pour obtenir plus d’informations.',
	...
	'RETRY' => 'Réessayer',
	'OVERRIDE' => 'Override',
	'TAGS_OVERRIDE_INFO' => 'Si décoché, les tags seront ajoutés aux tags de la photo.',

	'SETTINGS_SUCCESS_LOGIN' => 'Informations de connexion mise à jour.',
	'SETTINGS_SUCCESS_SORT' => 'Ordre d’affichage mis à jour.',
	'SETTINGS_SUCCESS_DROPBOX' => 'Clé Dropbox mise à jour.',
	'SETTINGS_SUCCESS_LANG' => 'Langue mis à jour.',
	...
	'U2F_NOT_SECURE' => 'Environment non sécurisé. U2F indisponible.',
	...
	'USER_EMAIL_INSTRUCTION' => 'Ajouter votre adresse email ci-dessous pour recevoir des notifications. Pour arrêter de recevoir des emails, enlever simplement votre adresse ci-dessous.',

	'LOGIN_USERNAME' => 'Nouvel utilisateur',
	'LOGIN_PASSWORD' => 'Nouveau mot de passe',
	'LOGIN_PASSWORD_CONFIRM' => 'Confirmez le mot de passe',
	'PASSWORD_TITLE' => 'Entrez votre mot de passe actuel:',
	...
	'SORT_PHOTO_SELECT_1' => 'Date de téléversement',
	...
	'DROPBOX_TEXT' => 'Pour pouvoir importer des photos à partir de votre Dropbox, vous aurez besoin d’une clé d’application «drop-ins» valide à créer sur <a href="https://www.dropbox.com/developers/saver\">leur site</a>. Générez votre clé personnelle puis saisissez-la ci-dessous :',
	...
	'CSS_TEXT' => 'Personnaliser le CSS :',
	'CSS_TITLE' => 'Personnaliser le CSS',
	'JS_TEXT' => 'Personnaliser le JS:',
	'JS_TITLE' => 'Personnaliser le code JS',
	...
	'SETTINGS_SUCCESS_NSFW_VISIBLE' => 'Visibilité par default des albums sensible mis à jour.',

	'NSFW_BANNER' => '<h1>Contenu sensible</h1><p>Cet album contient du contenu sensible qui peut déranger ou offenser certaines personnes.</p><p>Cliquer pour accepter.</p>',
	'NSFW_HEADER' => 'Contenu Sensible',
	'NSFW_EXPLANATION' => 'Cet album contient des contenus sensible que certaines personnes peuvent trouver choquant ou offensant.',
	'TAP_CONSENT' => 'Cliquer pour accepter.',
	...
	'UPLOAD_FAILED' => 'Échec',
	'UPLOAD_FAILED_ERROR' => 'Le téléversement a échoué. Le serveur a retourné une erreur !',
	'UPLOAD_FAILED_WARNING' => 'Le téléversement a échoué. Le serveur a retourné un avertissement !',
	'UPLOAD_CANCELLED' => 'Annulé',
	'UPLOAD_SKIPPED' => 'Ignoré',
	'UPLOAD_UPDATED' => 'Mis à jour',
	'UPLOAD_GENERAL' => 'General',
	'UPLOAD_IMPORT_SKIPPED_DUPLICATE' => 'Cette photo a été sautée parce qu’elle est deja dans votre galerie.',
	'UPLOAD_IMPORT_RESYNCED_DUPLICATE' => 'Cette photo a été sautée parce qu’elle est deja dans votre galerie mais ses metadatas ont été mises à jour.',
	...
	'UPLOAD_ERROR_UNKNOWN' => 'Le téléversement a échoué. Le serveur a retourné une erreur inconnue !',
	'UPLOAD_ERROR_POSTSIZE' => 'Le téléversement a échoué. La valeur PHP post_max_size est peut-être trop petit, sinon consultez la FAQ.',
	'UPLOAD_ERROR_FILESIZE' => 'Le téléversement a échoué. La valeur PHP upload_max_filesize est peut-être trop petit, sinon consultez la FAQ.',
	...
	'UPLOAD_ABSOLUTE_PATH' => 'Chemins absolus des répertoires, séparés par des espaces',
	...
	'UPLOAD_IMPORT_SKIP_DUPLICATES_EXPL' => 'Les médias déjà existants ne seront pas importés.',
	...
	'PHOTO_DIRECT_LINKS_TO_IMAGES' => 'Liens directs pour les fichiers de l’image :',
	'PHOTO_ORIGINAL' => 'Taille originale',
	'PHOTO_MEDIUM' => 'Taille moyenne',
	'PHOTO_MEDIUM_HIDPI' => 'Taille moyenne HiDPI',
	...
	'PHOTO_EDIT_ROTATECCWISE' => 'Pivoter dans le sens inverse des aiguilles d’une montre.',
	...
	'ERROR_PASSWORD_DOES_NOT_MATCH' => 'Le nouveau mot de passe ne correspond pas.',
	...
	'ERROR_DROPBOX_KEY' => 'Erreur : la clé Dropbox est vide',
	'ERROR_SESSION' => 'La session a expiré.',
	'CAMERA_DATE' => 'Camera date',
	'NEW_PASSWORD' => 'Nouveau mot de passe',
	'ALLOW_UPLOADS' => 'Autoriser les téléversements',
	'ALLOW_USER_SELF_EDIT' => 'Autoriser l’auto-gestion de compte utilisateur',
