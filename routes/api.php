...
Route::post('/Album::setPublic', [AlbumController::class, 'setPublic']);
...
Route::get('/Album::getArchive', [AlbumController::class, 'getArchive'])->middleware('local_storage');
...
Route::get('/Photo::getArchive', [PhotoController::class, 'getArchive'])->middleware('local_storage');
