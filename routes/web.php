...
Route::post('/api/Album::add',              'AlbumController@add')->middleware('login');
Route::post('/api/Album::setTitle',         'AlbumController@setTitle')->middleware('login');
Route::post('/api/Album::setDescription',   'AlbumController@setDescription')->middleware('login');
Route::post('/api/Album::setPublic',        'AlbumController@setPublic')->middleware('login');
Route::post('/api/Album::delete',           'AlbumController@delete')->middleware('login');
Route::post('/api/Album::merge',            'AlbumController@merge')->middleware('login');

Route::post('/api/Photo::get',              'PhotoController@get')->middleware('AlbumPWCheck');
Route::post('/api/Photo::setTitle',         'PhotoController@setTitle')->middleware('login');
Route::post('/api/Photo::setDescription',   'PhotoController@setDescription')->middleware('login');
Route::post('/api/Photo::setStar',          'PhotoController@setStar')->middleware('login');
Route::post('/api/Photo::setPublic',        'PhotoController@setPublic')->middleware('login');
Route::post('/api/Photo::setAlbum',         'PhotoController@setAlbum')->middleware('login');
Route::post('/api/Photo::setTags',          'PhotoController@setTags')->middleware('login');
Route::post('/api/Photo::add',              'PhotoController@add')->middleware('login');
Route::post('/api/Photo::delete',           'PhotoController@delete')->middleware('login');
Route::post('/api/Photo::duplicate',        'PhotoController@duplicate')->middleware('login');
