...
|-------------|---------|----------|---------|--------|--------|---------|
| ~~Q-054-01~~ | 054 – Configurable Landing Page | High | Architecture shape — multiple named layout templates vs. one mega-configurable single-shape hero vs. a fully modular/reorderable section builder | Resolved (multiple named layouts — classic/portfolio/minimal) | 2026-08-10 | 2026-08-10 |
| ~~Q-054-02~~ | 054 – Configurable Landing Page | High | Frontend scope — v8 (Nuxt UI) only vs. full v7+v8 parity | Resolved (v8 only, matches Feature 051 precedent) | 2026-08-10 | 2026-08-10 |
| ~~Q-054-03~~ | 054 – Configurable Landing Page | High | SE gating — free for everyone vs. classic layout free forever with new layouts/animations SE-exclusive | Resolved (classic + extra links free; portfolio/minimal layouts + premium animation presets SE-gated) | 2026-08-10 | 2026-08-10 |
| ~~Q-054-04~~ | 054 – Configurable Landing Page | Medium | Extra layouts beyond classic/portfolio/minimal — which of 5 brainstormed candidates (studio, mosaic/grid-first, coming-soon, split-screen, video-hero) to add now vs. defer | Resolved (add `studio` client-login-first layout only; mosaic/coming-soon/split-screen/video-hero deferred to backlog) | 2026-08-10 | 2026-08-10 |
| ~~Q-054-10~~ | 054 – Configurable Landing Page | Low | `LandingLink.icon` input — free-text Iconify identifier vs. a curated visual icon picker | Resolved (free-text, defaults to `lucide:link` when empty; no picker UI) | 2026-08-10 | 2026-08-10 |
| ~~Q-054-09~~ | 054 – Configurable Landing Page | High | Featured-content curation model — automatic-only, manual-only, or both; albums-only or photos+albums | Resolved (automatic by default, full manual curation also supported via new `LandingFeaturedItem` CRUD; manual mode covers both photos and albums) | 2026-08-10 | 2026-08-10 |
| ~~Q-054-08~~ | 054 – Configurable Landing Page | Medium | `LandingConfig.vue` scope — absorb only the 11 new keys, or the entire pre-existing `Mod Welcome` settings category | Resolved (entire category absorbed; category filtered out of the flat generic Settings list — a deliberate deviation from Feature 045's precedent since NSFW curates only a subset) | 2026-08-10 | 2026-08-10 |
| ~~Q-054-07~~ | 054 – Configurable Landing Page | Medium | Landing-specific custom CSS override (`landing_custom_css`) vs. reusing Lychee's existing global custom CSS/JS mechanism | Resolved (dropped entirely — reuse the existing global `dist/user.css`/`dist/custom.js` mechanism, already loaded on every page incl. landing; admin configures selectors themselves) | 2026-08-10 | 2026-08-10 |
| ~~Q-054-06~~ | 054 – Configurable Landing Page | Medium | Admin UI approach — flat generic settings list only vs. a dedicated curated config page like Feature 045's `NsfwConfig.vue` | Resolved (dedicated `LandingConfig.vue` page, `UTabs` with Settings + Links tabs, mirrors `NsfwConfig.vue`; generic list keeps working unfiltered alongside it — later widened by Q-054-08 to full-category absorption + filtering) | 2026-08-10 | 2026-08-10 |
| ~~Q-054-05~~ | 054 – Configurable Landing Page | Medium | Non-layout improvements — which of ~10 brainstormed additions (contact surfacing, CTA text override, scroll indicator, custom CSS override, About-section image slot, testimonials block, etc.) to fold in now vs. defer | Resolved (add contact-form surfacing on portfolio/minimal, configurable CTA text, portfolio scroll-down indicator, and a raw CSS override; testimonials block and second About-section image slot deferred to backlog) | 2026-08-10 | 2026-08-10 |
