...
|------------|------|-----------|-------|
| 041 | Album Tags | 2026-05-31 | Added direct tags for regular albums via `albums_tags`, `Album::albumTags` PATCH API, editable resource/head loading, AlbumProperties UI editing, and validated with frontend checks, targeted tests, and PHPStan. |
