...
- [x] T-037-01 – Create config migration for `use_admin_dashboard` (FR-037-03, Q-037-06).  
...
- [x] T-037-02 – Write `tests/Feature_v2/Admin/ConfigTogglePresentTest.php` (RED) then run migration to green (FR-037-03, S-037-04, S-037-05).  
...
- [x] T-037-03 – Surface `use_admin_dashboard` through `LycheeStateStore` resource (FR-037-03, S-037-04, S-037-05).  
...
- [x] T-037-04 – Create `app/DTO/AdminStatsOverview.php` (DO-037-01).  
...
- [x] T-037-05 – Write `tests/Unit/Services/AdminStatsServiceTest.php` (RED) covering all cache + error paths (API-037-01, NFR-037-01, NFR-037-02, S-037-09, S-037-10, S-037-11, Q-037-02).  
  _Intent:_ Cases:
...
- [x] T-037-06 – Implement `app/Services/AdminStatsService.php::getOverview(bool $force = false): AdminStatsOverview` (API-037-01, NFR-037-01, NFR-037-02).  
...
- [x] T-037-07 – Create `app/Http/Resources/Models/AdminStatsResource.php` (API-037-01, DO-037-01).  
...
- [x] T-037-08 – Create `app/Http/Requests/Admin/AdminStatsRequest.php` with `SettingsPolicy::CAN_EDIT` authorisation (API-037-01, NFR-037-03, S-037-02, S-037-17).  
...
- [x] T-037-09 – Write `tests/Feature_v2/Admin/AdminStatsControllerTest.php` (RED) covering six scenarios (S-037-01, S-037-02, S-037-09, S-037-10, S-037-11, S-037-17, NFR-037-01).  
  _Intent:_ Cases:
...
- [x] T-037-10 – Implement `app/Http/Controllers/Admin/AdminDashboardController.php::stats` and register the route (FR-037-02, API-037-01, NFR-037-03).  
...
- [x] T-037-11 – Write router Vitest `resources/js/router/__tests__/admin-routes.test.ts` (RED) (FR-037-05, S-037-06, S-037-07, S-037-08, S-037-14).  
...
- [x] T-037-12 – Create `resources/js/views/admin/` and relocate the nine admin views (FR-037-05, UI-037-04).  
...
- [x] T-037-13 – Create placeholder `resources/js/views/admin/AdminDashboard.vue` (UI-037-01).  
...
- [x] T-037-14 – Update `resources/js/router/routes.ts` with new paths + imports (FR-037-05, UI-037-04, S-037-06, S-037-14).  
...
- [x] T-037-15 – Fix any broken `@/views/*` imports after the move (supporting task for T-037-12).  
...
- [x] T-037-16 – Update `resources/js/lychee.d.ts` with `AdminStatsResource` namespace (API-037-01).  
...
- [x] T-037-17 – Create `resources/js/services/admin-stats-service.ts` (API-037-01).  
...
- [x] T-037-18 – Create `resources/js/composables/useAdminTiles.ts` (FR-037-04, UI-037-01, UI-037-01a, S-037-15, S-037-16, Q-037-08).  
...
- [x] T-037-19 – Write `resources/js/views/admin/__tests__/AdminDashboard.test.ts` (RED) (UI-037-01, UI-037-01a, UI-037-02, UI-037-03, S-037-01, S-037-03, S-037-13, S-037-16).  
  _Intent:_ Cases:
...
- [x] T-037-20 – Implement `resources/js/views/admin/AdminDashboard.vue` to green the Vitest cases (UI-037-01, UI-037-01a, UI-037-02, UI-037-03).  
...
- [x] T-037-21 – Write `resources/js/composables/__tests__/leftMenu.admin.test.ts` (RED) (FR-037-03, FR-037-04, S-037-04, S-037-05, S-037-16, S-037-18, Q-037-08).  
  _Intent:_ Cases:
...
- [x] T-037-22 – Update `resources/js/composables/contextMenus/leftMenu.ts` with the toggle branch (FR-037-03, FR-037-04, S-037-04, S-037-05, S-037-16, S-037-18).  
...
- [x] T-037-23 – Add new i18n keys to English authoritative `lang/en.json` (FR-037-04, UI-037-04, UI-037-05, S-037-12).  
...
- [x] T-037-24 – Propagate new i18n keys to the remaining 21 locale files (S-037-12, NFR-037-04).  
...
- [x] T-037-25 – Regenerate OpenAPI snapshot for `GET /api/v2/Admin/Stats` (API-037-01).  
...
- [x] T-037-26 – Update `docs/specs/4-architecture/knowledge-map.md` (NFR-037-05).  
...
- [x] T-037-27 – Add operator how-to `docs/specs/2-how-to/admin-dashboard.md` (NFR-037-05).  
...
- [x] T-037-28 – Run full PHP quality gate (exit criterion).  
...
- [x] T-037-29 – Run full frontend quality gate (exit criterion).  
  _Intent:_ Ensure I4–I6 changes are typecheck/eslint/prettier-clean and Vitest is green.  
  _Verification commands:_
  - `npm run check`
  - `npm run format --check`

- [x] T-037-30 – Move Feature 037 from Active → Completed in `docs/specs/4-architecture/roadmap.md`, update `_current-session.md` (NFR-037-05).  
