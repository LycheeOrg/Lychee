...
### I6 – Sharing API
- [x] T-072-10 – Failing tests: S-072-20 (create/edit without → 422 (revised, see D-072-J), propagate copies, 422 on non-boolean); response carries `grants_move` (F-072-05).  
