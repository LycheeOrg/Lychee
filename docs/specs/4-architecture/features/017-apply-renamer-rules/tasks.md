...
- [ ] T-017-01 – Extend `Renamer` constructor to accept optional `rule_ids` filter.  
...
- [ ] T-017-01b – Extend `RenameRequest` and `RenamerController::rename()` with optional `rule_ids[]`.  
...
- [ ] T-017-02 – Create `PreviewRenameRequest` form request (FR-017-04, S-017-10, S-017-11, S-017-12).  
...
- [ ] T-017-03 – Write feature tests for preview endpoint (S-017-08, S-017-09, S-017-10, S-017-11, S-017-12).  
...
- [ ] T-017-09 – Create `ApplyRenamerDialog.vue` — Step 1 UI (FR-017-02, FR-017-03, S-017-05, S-017-06, S-017-07, S-017-22, S-017-23, S-017-24, S-017-25, S-017-26).  
...
- [ ] T-017-23 – Add English translations to `lang/en/gallery.php` and `lang/en/dialogs.php`.  
...
- [ ] T-017-24 – Add placeholder translations to 21 other `lang/<locale>/gallery.php` and `lang/<locale>/dialogs.php` files.  
