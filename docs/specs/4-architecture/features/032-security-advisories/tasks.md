...
- [x] T-032-01 – Add `advisories` config block to `config/urls.php` and `vulnerability-check` flag to `config/features.php` (FR-032-01, FR-032-08, NFR-032-03, NFR-032-04).  
...
- [x] T-032-02 – Create `app/DTO/SecurityAdvisory.php` (DO-032-01).  
...
- [x] T-032-03 – Write `tests/Unit/Services/VersionRangeCheckerTest.php` (RED) then create `app/Services/VersionRangeChecker.php` (DO-032-02, NFR-032-06, S-032-13, Q-032-03).  
...
- [x] T-032-04 – Extend `app/Metadata/Json/ExternalRequestFunctions.php` to support custom HTTP headers (NFR-032-05).  
...
- [x] T-032-05 – Create `app/Metadata/Json/AdvisoriesRequest.php` (FR-032-01, NFR-032-05).  
...
- [x] T-032-06 – Create test fixture `tests/Fixtures/github-security-advisories.json` (FX-032-01).  
...
- [x] T-032-07 – Write `tests/Unit/Services/SecurityAdvisoriesServiceTest.php` (RED) then create `app/Services/SecurityAdvisoriesService.php` (FR-032-01, FR-032-02, FR-032-03, FR-032-08, S-032-01, S-032-02, S-032-03, S-032-05, S-032-06, S-032-09, Q-032-03, Q-032-04, Q-032-06).  
...
- [x] T-032-08 – Write `tests/Unit/Actions/Diagnostics/SecurityAdvisoriesCheckTest.php` (RED) then create `app/Actions/Diagnostics/Pipes/Checks/SecurityAdvisoriesCheck.php` and register it in `Errors.php` (FR-032-04, S-032-01, S-032-02, S-032-03, S-032-04, NFR-032-01, Q-032-05, Q-032-07).  
...
- [x] T-032-09 – Create `app/Http/Resources/Models/SecurityAdvisoryResource.php` (API-032-01).  
...
- [x] T-032-10 – Write feature tests `tests/Feature_v2/SecurityAdvisories/IndexTest.php` (RED) then create `app/Http/Controllers/Admin/SecurityAdvisoriesController.php` and register the route (FR-032-05, FR-032-08, S-032-01, S-032-07, S-032-08, NFR-032-01).  
...
- [x] T-032-11 – Update `resources/js/lychee.d.ts` to add `SecurityAdvisoryResource` type (API-032-01).  
...
- [x] T-032-12 – Create `resources/js/services/security-advisories-service.ts`.  
...
- [x] T-032-13 – Write Vitest unit test then create `resources/js/components/modals/SecurityAdvisoriesModal.vue` (FR-032-06, FR-032-07, UI-032-01, UI-032-02, UI-032-03, S-032-10, S-032-11, Q-032-01, Q-032-02, Q-032-05, Q-032-07).  
...
- [x] T-032-14 – Integrate advisory check into post-login flow (FR-032-06, FR-032-07, FR-032-08, S-032-01, S-032-10, S-032-11, S-032-12, Q-032-09, Q-032-10).  
...
- [x] T-032-15 – Run full PHP test suite and all quality gates (exit criterion).  
...
- [x] T-032-16 – Run full frontend quality gates (exit criterion).  
...
- [x] T-032-17 – Update `docs/specs/4-architecture/knowledge-map.md` with `SecurityAdvisoriesService` and `SecurityAdvisoriesCheck` entries.  
...
- [x] T-032-18 – Move Feature 032 in `docs/specs/4-architecture/roadmap.md` from Active → Completed.  
