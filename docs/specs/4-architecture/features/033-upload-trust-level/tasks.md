...
- [ ] T-033-01 – Create `UserUploadTrustLevel` string-backed enum (FR-033-01, DO-033-01).  
...
- [ ] T-033-02 – Create migration: add `upload_trust_level` to `users` table (FR-033-01, DO-033-02, NFR-033-02, NFR-033-06).  
...
- [ ] T-033-03 – Create migration: add `is_upload_validated` to `photos` table (FR-033-02, DO-033-03, NFR-033-01, NFR-033-02).  
...
- [ ] T-033-04 – Create config migration: `default_user_trust_level` and `guest_upload_trust_level` (FR-033-09, DO-033-04).  
...
- [ ] T-033-05 – Update `User` model with `upload_trust_level` property and cast (FR-033-01, DO-033-02).  
...
- [ ] T-033-06 – Update `Photo` model with `is_upload_validated` property and cast (FR-033-02, DO-033-03).  
...
- [ ] T-033-06b – Update `UserFactory` with `upload_trust_level` default (FX-033-01).  
...
- [ ] T-033-10 – Update `applyVisibilityFilter` to exclude unvalidated photos (FR-033-05, S-033-08, S-033-09, S-033-10).  
...
- [ ] T-033-11 – Update `applySearchabilityFilter` to exclude unvalidated photos (FR-033-05, S-033-19).  
...
- [ ] T-033-12 – Write feature tests for visibility filtering with trust levels (S-033-08, S-033-09, S-033-10, S-033-19, S-033-20).  
...
- [ ] T-033-13 – Add `UPLOAD_TRUST_LEVEL_ATTRIBUTE` to `RequestAttribute` constants (DO-033-02).  
...
- [ ] T-033-14 – Update `AddUserRequest` to accept `upload_trust_level` (FR-033-08, S-033-01, S-033-02).  
...
- [ ] T-033-15 – Update `SetUserSettingsRequest` to accept `upload_trust_level` (FR-033-08, S-033-03, S-033-04).  
...
- [ ] T-033-16 – Update `Create` user action for trust level (FR-033-08).  
...
- [ ] T-033-17 – Update `Save` user action for trust level (FR-033-08).  
...
- [ ] T-033-18 – Update `UserManagementController` to pass trust level (FR-033-08, FR-033-12, S-033-21).  
...
- [ ] T-033-19 – Update `UserManagementResource` with trust level (FR-033-12, S-033-21).  
...
- [ ] T-033-19b – Update `PhotoResource` with `is_upload_validated` (FR-033-13, S-033-22).  
...
- [ ] T-033-19c – Write feature tests for user management trust level CRUD (S-033-01, S-033-02, S-033-03, S-033-04, S-033-21).  
...
- [ ] T-033-20 – Create `ModerationResource` (Spatie Data) (API-033-01).  
...
- [ ] T-033-21 – Create `ListModerationRequest` and `ApproveModerationRequest` (API-033-01, API-033-02).  
...
- [ ] T-033-22 – Create `ModerationController` (FR-033-10, FR-033-11, API-033-01, API-033-02).  
...
- [ ] T-033-23 – Register moderation routes (API-033-01, API-033-02).  
...
- [ ] T-033-24 – Write feature tests for moderation API (S-033-11, S-033-12, S-033-13, S-033-14, S-033-17, S-033-18).  
...
- [ ] T-033-25 – Update TypeScript types for trust level (DO-033-01, S-033-21).  
...
- [ ] T-033-26 – Update `user-management-service.ts` for trust level (API-033-03, API-033-04).  
...
- [ ] T-033-27 – Update `CreateEditUser.vue` with trust level dropdown (UI-033-01, UI-033-09).  
...
- [ ] T-033-28 – Update `ListUser.vue` with trust level indicator (UI-033-02).  
...
- [ ] T-033-28b – Update `Users.vue` legend with trust level (UI-033-02).  
  _Intent:_ Add trust level icon and description to the legend card.  
  _Files:_ `resources/js/views/Users.vue`  
  _Verification commands:_  
  - `npm run check`  

- [ ] T-033-28c – Add English language strings for trust level (UI-033-01, UI-033-02).  
...
- [ ] T-033-29 – Create `moderation-service.ts` (API-033-01, API-033-02).  
...
- [ ] T-033-30 – Update TypeScript types for moderation (DO-033-03, API-033-01).  
  _Intent:_ Add `ModerationResource` type to `lychee.d.ts`. Add `is_upload_validated: boolean` to `PhotoResource` type.  
  _Files:_ `resources/js/lychee.d.ts`  
  _Verification commands:_  
  - `npm run check`  

- [ ] T-033-31 – Create `Moderation.vue` view (UI-033-03, UI-033-05, UI-033-06, UI-033-07, UI-033-08).  
...
- [ ] T-033-34 – Create English language file for moderation (UI-033-03).  
