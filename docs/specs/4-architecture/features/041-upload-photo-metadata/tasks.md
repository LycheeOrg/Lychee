...
- [ ] T-041-01 – Write failing feature-test stubs for S-041-01, S-041-02, S-041-03, S-041-05, S-041-06, S-041-07 (FR-041-01 through FR-041-10, S-041-01 to S-041-07).  
...
- [ ] T-041-02 – Add `title`, `description`, `preallocated_id` to `ImportParam` (FR-041-01, FR-041-02, FR-041-07).  
...
- [ ] T-041-03 – Propagate new fields through `InitDTO` and `StandaloneDTO::ofInit()` (FR-041-07, S-041-05).  
...
- [ ] T-041-04 – Add `Photo::preallocateId()` and guard in `generateKey()` (FR-041-07, FR-041-08, S-041-05).  
...
- [ ] T-041-05 – Create `ApplyUserProvidedMetadata` pipe with unit test (FR-041-03, FR-041-04, S-041-01, S-041-11).  
...
- [ ] T-041-07 – Add `title` validation to `UploadPhotoRequest`; test S-041-08 (FR-041-01, S-041-08).  
...
- [ ] T-041-08 – Add `description` validation to `UploadPhotoRequest`; test S-041-09 (FR-041-02, S-041-09).  
...
- [ ] T-041-09 – Add `expected_id`, `title`, `description` to `UploadMetaResource` (FR-041-11, DO-041-01, S-041-04, S-041-07).  
...
- [ ] T-041-10 – Update `PhotoController::upload()` and `process()` to generate `expected_id` and forward `title`/`description` (FR-041-07, FR-041-10, S-041-04, S-041-05, S-041-07).  
...
- [ ] T-041-11 – Update `ProcessImageJob` to carry and use `expected_id`, `title`, `description` (FR-041-07, DO-041-05).  
