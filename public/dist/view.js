...
var _templateObject = _taggedTemplateLiteral(["<svg class='iconic ", "'><use xlink:href='#", "' /></svg>"], ["<svg class='iconic ", "'><use xlink:href='#", "' /></svg>"]),
    ...
    _templateObject24 = _taggedTemplateLiteral(["<span class='attr_", "_separator'>, </span>"], ["<span class='attr_", "_separator'>, </span>"]),
    _templateObject25 = _taggedTemplateLiteral(["<span class='attr_", " search'>$", "</span>"], ["<span class='attr_", " search'>$", "</span>"]),
    _templateObject26 = _taggedTemplateLiteral(["<span class='attr_", "'>$", "</span>"], ["<span class='attr_", "'>$", "</span>"]),
...
header.setTitle = function (title) {
	...
	var html = lychee.html(_templateObject23, title, build.iconic("caret-bottom"));
...
sidebar.render = function (structure) {
	...
	var renderDefault = function renderDefault(section) {
      ...
      */
					function (prev, cur) {
						...
						if (prev !== "") {
							prev += lychee.html(_templateObject24, row.kind);
						}
						return prev + lychee.html(_templateObject25, row.kind, cur);
					}, "");
				} else {
					value = lychee.html(_templateObject26, row.kind, value);
				}

				// Add edit-icon to the value when editable
				if (row.editable === true) value += " " + build.editIcon("edit_" + row.kind);

				_html += lychee.html(_templateObject27, row.title, value);
			}
		});
  ...
  */
	var renderTags = function renderTags(section) {
		...
		_html += lychee.html(_templateObject28, section.title, section.title.toLowerCase(), section.value, editable);
